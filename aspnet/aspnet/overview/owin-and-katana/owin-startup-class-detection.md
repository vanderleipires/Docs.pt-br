...
- Adicione uma classe de inicialização OWIN. No Visual Studio 2013 clique com botão direito no projeto e selecione **Adicionar classe**. - na **Adicionar Novo Item** caixa de diálogo, digite *OWIN* no campo de pesquisa e altere o nome para Startup.cs, e, em seguida, clique em **adicionar**.  
