...
====================
<span data-ttu-id="ec71d-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="ec71d-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="ec71d-104">Observação: Os scripts de globalização, como FR.js-fr, podem ser encontrados na seguinte pasta:</span><span class="sxs-lookup"><span data-stu-id="ec71d-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
