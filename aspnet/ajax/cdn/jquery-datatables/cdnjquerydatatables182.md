...
ms.locfileid: "37390246"
---
<a name="jquery-datatables-182"></a><span data-ttu-id="3321a-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="3321a-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="3321a-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="3321a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
