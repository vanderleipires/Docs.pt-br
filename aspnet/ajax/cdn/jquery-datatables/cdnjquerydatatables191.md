...
ms.locfileid: "37817143"
---
<a name="jquery-datatables-191"></a><span data-ttu-id="5fc08-102">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="5fc08-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="5fc08-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="5fc08-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
