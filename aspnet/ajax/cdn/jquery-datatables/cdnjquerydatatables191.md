...
---
<a name="jquery-datatables-191"></a><span data-ttu-id="db024-102">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="db024-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="db024-103">Os seguintes arquivos para o jQuery DataTables plug-ins são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="db024-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
