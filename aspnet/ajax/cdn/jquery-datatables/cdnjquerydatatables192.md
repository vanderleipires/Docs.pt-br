...
ms.locfileid: "37824128"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="187ea-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="187ea-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="187ea-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="187ea-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
