...
ms.locfileid: "41831048"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="977c1-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="977c1-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="977c1-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="977c1-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
