...
ms.locfileid: "37824713"
---
<a name="jquery-datatables-193"></a><span data-ttu-id="2a351-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="2a351-102">jQuery DataTables 1.9.3</span></span>
====================
<span data-ttu-id="2a351-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="2a351-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
