...
ms.locfileid: "37818172"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="8cbb5-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="8cbb5-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="8cbb5-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="8cbb5-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
