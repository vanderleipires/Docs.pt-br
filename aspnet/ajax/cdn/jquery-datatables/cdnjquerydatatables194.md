...
ms.locfileid: "30071188"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="99b28-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="99b28-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="99b28-103">Os seguintes arquivos para o jQuery DataTables plug-ins são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="99b28-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
