...
ms.locfileid: "37822934"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="104b0-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="104b0-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="104b0-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="104b0-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
