...
ms.locfileid: "37821876"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="d552f-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="d552f-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="d552f-103">Os seguintes arquivos para o plug-ins de DataTables do jQuery são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="d552f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
