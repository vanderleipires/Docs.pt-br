...
ms.locfileid: "41830610"
---
<a name="jquery-validation-1140"></a><span data-ttu-id="97a64-102">Validação do jQuery 1.14.0</span><span class="sxs-lookup"><span data-stu-id="97a64-102">jQuery Validation 1.14.0</span></span>
====================
<span data-ttu-id="97a64-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="97a64-103">The following files are hosted on the CDN:</span></span>
