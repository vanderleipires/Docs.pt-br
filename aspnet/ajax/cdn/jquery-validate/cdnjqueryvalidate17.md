...
ms.locfileid: "30077437"
---
<a name="jqueryvalidate-version-17"></a><span data-ttu-id="3f63d-102">jQuery.Validate versão 1.7</span><span class="sxs-lookup"><span data-stu-id="3f63d-102">jquery.validate version 1.7</span></span>
====================
<span data-ttu-id="3f63d-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="3f63d-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="3f63d-104">Arquivos de localização</span><span class="sxs-lookup"><span data-stu-id="3f63d-104">Localization Files</span></span>
