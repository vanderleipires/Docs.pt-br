...
ms.locfileid: "37817863"
---
<a name="jquery-validation-1151"></a><span data-ttu-id="2bc1a-102">Validação do jQuery 1.15.1</span><span class="sxs-lookup"><span data-stu-id="2bc1a-102">jQuery Validation 1.15.1</span></span>
====================
<span data-ttu-id="2bc1a-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="2bc1a-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="2bc1a-104">Arquivos de localização em https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js onde # # é o código de loc.</span><span class="sxs-lookup"><span data-stu-id="2bc1a-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js where ## is the loc code.</span></span>
