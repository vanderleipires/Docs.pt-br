...
ms.locfileid: "41832446"
---
<a name="jquery-validation-1151"></a><span data-ttu-id="074c9-102">Validação do jQuery 1.15.1</span><span class="sxs-lookup"><span data-stu-id="074c9-102">jQuery Validation 1.15.1</span></span>
====================
<span data-ttu-id="074c9-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="074c9-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="074c9-104">Arquivos de localização em https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js onde # # é o código de loc.</span><span class="sxs-lookup"><span data-stu-id="074c9-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js where ## is the loc code.</span></span>
