...
ms.locfileid: "30072331"
---
<a name="jquery-validation-1110"></a><span data-ttu-id="c2762-102">jQuery validação 1.11.0</span><span class="sxs-lookup"><span data-stu-id="c2762-102">jQuery Validation 1.11.0</span></span>
====================
<span data-ttu-id="c2762-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="c2762-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c2762-104">Arquivos de localização em https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages \_. js de # # onde # # é o código loc.</span><span class="sxs-lookup"><span data-stu-id="c2762-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js where ## is the loc code.</span></span>
