...
ms.locfileid: "37835904"
---
<a name="jquery-validation-1170"></a><span data-ttu-id="24598-102">jQuery Validation 1.17.0</span><span class="sxs-lookup"><span data-stu-id="24598-102">jQuery Validation 1.17.0</span></span>
====================
<span data-ttu-id="24598-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="24598-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="24598-104">Arquivos de localização em https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js onde # # é o código de loc.</span><span class="sxs-lookup"><span data-stu-id="24598-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
