...
ms.locfileid: "37836546"
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="e9f14-102">jQuery. Validate versão 1.8.1</span><span class="sxs-lookup"><span data-stu-id="e9f14-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="e9f14-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="e9f14-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="e9f14-104">Arquivos de localização em https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js onde # # é o código de loc.</span><span class="sxs-lookup"><span data-stu-id="e9f14-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
