...
ms.locfileid: "37836704"
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="16e9e-102">jQuery. Validate versão 1.8</span><span class="sxs-lookup"><span data-stu-id="16e9e-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="16e9e-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="16e9e-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="16e9e-104">Arquivos de localização em https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js onde # # é o código de loc.</span><span class="sxs-lookup"><span data-stu-id="16e9e-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
