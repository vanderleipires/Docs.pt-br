...
ms.locfileid: "30070440"
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="fdd25-102">jQuery.Validate versão 1.8</span><span class="sxs-lookup"><span data-stu-id="fdd25-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="fdd25-103">Os seguintes arquivos são hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="fdd25-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="fdd25-104">Arquivos de localização em https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages \_. js de # # onde # # é o código loc.</span><span class="sxs-lookup"><span data-stu-id="fdd25-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
