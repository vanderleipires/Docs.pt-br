...
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="1a85b-102">jQuery modelos Beta 1</span><span class="sxs-lookup"><span data-stu-id="1a85b-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="1a85b-103">O plug-in de modelos jQuery inclui os seguintes arquivos:</span><span class="sxs-lookup"><span data-stu-id="1a85b-103">The jQuery Templates plugin includes the following files:</span></span>
