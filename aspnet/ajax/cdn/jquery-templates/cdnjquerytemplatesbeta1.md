...
ms.locfileid: "37394528"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="5b314-102">Modelos jQuery Beta 1</span><span class="sxs-lookup"><span data-stu-id="5b314-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="5b314-103">O plug-in do jQuery modelos inclui os seguintes arquivos:</span><span class="sxs-lookup"><span data-stu-id="5b314-103">The jQuery Templates plugin includes the following files:</span></span>
