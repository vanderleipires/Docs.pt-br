...
ms.locfileid: "37368144"
---
<a name="jquery-mobile-110-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="bff6a-102">jQuery Mobile 1.1.0 na CDN do Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="bff6a-102">jQuery Mobile 1.1.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="bff6a-103">A biblioteca do jQuery Mobile 1.1.0 inclui os seguintes arquivos:</span><span class="sxs-lookup"><span data-stu-id="bff6a-103">The jQuery Mobile 1.1.0 library includes the following files:</span></span>
