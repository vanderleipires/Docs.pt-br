...
<span data-ttu-id="0ff44-158">Nesta tarefa, você criará as classes do controlador no qual os métodos de API residirá.</span><span class="sxs-lookup"><span data-stu-id="0ff44-158">In this task, you will create the controller classes in which API methods will reside.</span></span>
...
5. <span data-ttu-id="0ff44-170">Pressione **F5** para depurar o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="0ff44-170">Press **F5** to debug the application.</span></span> <span data-ttu-id="0ff44-171">A home page padrão para um projeto de API da Web deve aparecer.</span><span class="sxs-lookup"><span data-stu-id="0ff44-171">The default home page for a Web API project should appear.</span></span>
    ...
    <span data-ttu-id="0ff44-173">*A home page padrão de um aplicativo de API Web ASP.NET*</span><span class="sxs-lookup"><span data-stu-id="0ff44-173">*The default home page of an ASP.NET Web API application*</span></span>
...
2. <span data-ttu-id="0ff44-198">No **Adicionar Novo Item** caixa de diálogo, nomeie o novo arquivo **Contact.cs** e clique em **adicionar.**</span><span class="sxs-lookup"><span data-stu-id="0ff44-198">In the **Add New Item** dialog, name the new file **Contact.cs** and click **Add.**</span></span>
    ...
    <span data-ttu-id="0ff44-200">*Criar o novo arquivo de classe do contato*</span><span class="sxs-lookup"><span data-stu-id="0ff44-200">*Creating the new Contact class file*</span></span>
...
3. <span data-ttu-id="0ff44-281">Modificar o código para o **GetAllContacts** método conforme demonstrado a seguir.</span><span class="sxs-lookup"><span data-stu-id="0ff44-281">Modify the code for the **GetAllContacts** method as demonstrated below.</span></span>
    ...
    <span data-ttu-id="0ff44-282">(Código de trecho de código – *laboratório de API da Web - Ex02 - obter todos os contatos*)</span><span class="sxs-lookup"><span data-stu-id="0ff44-282">(Code Snippet - *Web API Lab - Ex02 - Get All Contacts*)</span></span>
...
<span data-ttu-id="0ff44-292">Nesta tarefa, você modificará a exibição de índice padrão do aplicativo web para dar suporte a necessidade de exibir a lista de contatos existentes em um navegador HTML.</span><span class="sxs-lookup"><span data-stu-id="0ff44-292">In this task, you will modify the default Index view of the web application to support the requirement of displaying the list of existing contacts in an HTML browser.</span></span>
...
10. <span data-ttu-id="0ff44-316">Remover o ponto de interrupção e pressione **F5** ou a barra de ferramentas depuração **continuar** botão para continuar carregando o modo de exibição no navegador.</span><span class="sxs-lookup"><span data-stu-id="0ff44-316">Remove the breakpoint and press **F5** or the debugging toolbar's **Continue** button to continue loading the view in the browser.</span></span> <span data-ttu-id="0ff44-317">Após a conclusão da chamada à API Web você deve ver os contatos retornados da API Web chamar exibidos como itens de lista no navegador.</span><span class="sxs-lookup"><span data-stu-id="0ff44-317">Once the Web API call completes you should see the contacts returned from the Web API call displayed as list items in the browser.</span></span>
    ...
    <span data-ttu-id="0ff44-319">*Resultados da chamada à API exibida no navegador, como itens de lista*</span><span class="sxs-lookup"><span data-stu-id="0ff44-319">*Results of the API call displayed in the browser as list items*</span></span>
...
11. <span data-ttu-id="0ff44-343">Se você pressionar **F5** ou clique em **continuar** no depurador, a solicitação será concluída.</span><span class="sxs-lookup"><span data-stu-id="0ff44-343">If you press **F5** or click **Continue** in the debugger the request will complete.</span></span> <span data-ttu-id="0ff44-344">Depois que você alternar de volta para o navegador, o novo contato foi adicionado à lista de contatos armazenados pelo **ContactRepository** implementação.</span><span class="sxs-lookup"><span data-stu-id="0ff44-344">Once you switch back to the browser, the new contact has been added to the list of contacts stored by the **ContactRepository** implementation.</span></span>
   ...
   <span data-ttu-id="0ff44-346">*O navegador reflete a criação bem-sucedida da nova instância de contato*</span><span class="sxs-lookup"><span data-stu-id="0ff44-346">*The browser reflects successful creation of the new contact instance*</span></span>
...
5. <span data-ttu-id="0ff44-365">Pressione a tecla Tab duas vezes para inserir o trecho de código no local do cursor.</span><span class="sxs-lookup"><span data-stu-id="0ff44-365">Press the Tab key twice to insert the snippet at the cursor location.</span></span>
    ...
    <span data-ttu-id="0ff44-369">*Pressione Tab para selecionar o trecho de código realçado*</span><span class="sxs-lookup"><span data-stu-id="0ff44-369">*Press Tab to select the highlighted snippet*</span></span>
...
1. <span data-ttu-id="0ff44-406">Vá para o [Portal de gerenciamento](https://manage.windowsazure.com/) e entre usando as credenciais da Microsoft associadas à sua assinatura.</span><span class="sxs-lookup"><span data-stu-id="0ff44-406">Go to the [Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>
    ...
    <span data-ttu-id="0ff44-410">*Faça logon no Portal*</span><span class="sxs-lookup"><span data-stu-id="0ff44-410">*Log on to Portal*</span></span>
2. <span data-ttu-id="0ff44-411">Clique em **New** na barra de comandos.</span><span class="sxs-lookup"><span data-stu-id="0ff44-411">Click **New** on the command bar.</span></span>

    <span data-ttu-id="0ff44-412">![Criando um novo Site](build-restful-apis-with-aspnet-web-api/_static/image40.png "criando um novo Site")</span><span class="sxs-lookup"><span data-stu-id="0ff44-412">![Creating a new Web Site](build-restful-apis-with-aspnet-web-api/_static/image40.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="0ff44-413">*Criando um novo Site*</span><span class="sxs-lookup"><span data-stu-id="0ff44-413">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="0ff44-414">Clique em **Compute** | **Site da Web**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-414">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="0ff44-415">Em seguida, selecione **criação rápida** opção.</span><span class="sxs-lookup"><span data-stu-id="0ff44-415">Then select **Quick Create** option.</span></span> <span data-ttu-id="0ff44-416">Forneça uma URL disponível para o novo site da web e clique em **Criar Site**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-416">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="0ff44-417">O Azure é o host para um aplicativo web em execução na nuvem que você pode controlar e gerenciar.</span><span class="sxs-lookup"><span data-stu-id="0ff44-417">Azure is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="0ff44-418">A opção criação rápida permite que você implante um aplicativo web concluído no Azure de fora do portal.</span><span class="sxs-lookup"><span data-stu-id="0ff44-418">The Quick Create option allows you to deploy a completed web application to the Azure from outside the portal.</span></span> <span data-ttu-id="0ff44-419">Ele não inclui as etapas para configurar um banco de dados.</span><span class="sxs-lookup"><span data-stu-id="0ff44-419">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="0ff44-420">![Criando um novo Site usando a criação rápida](build-restful-apis-with-aspnet-web-api/_static/image41.png "criando um novo Site usando a criação rápida")</span><span class="sxs-lookup"><span data-stu-id="0ff44-420">![Creating a new Web Site using Quick Create](build-restful-apis-with-aspnet-web-api/_static/image41.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="0ff44-421">*Criando um novo Site usando a criação rápida*</span><span class="sxs-lookup"><span data-stu-id="0ff44-421">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="0ff44-422">Aguarde até que o novo **Site da Web** é criado.</span><span class="sxs-lookup"><span data-stu-id="0ff44-422">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="0ff44-423">Depois que o Site da Web é criado, clique no link sob a **URL** coluna.</span><span class="sxs-lookup"><span data-stu-id="0ff44-423">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="0ff44-424">Verifique se o novo Site da Web está funcionando.</span><span class="sxs-lookup"><span data-stu-id="0ff44-424">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="0ff44-425">![Navegando até o novo site](build-restful-apis-with-aspnet-web-api/_static/image42.png "navegando até o novo site da web")</span><span class="sxs-lookup"><span data-stu-id="0ff44-425">![Browsing to the new web site](build-restful-apis-with-aspnet-web-api/_static/image42.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="0ff44-426">*Navegando até o novo site da web*</span><span class="sxs-lookup"><span data-stu-id="0ff44-426">*Browsing to the new web site*</span></span>

    <span data-ttu-id="0ff44-427">![Site da Web em execução](build-restful-apis-with-aspnet-web-api/_static/image43.png "site da Web em execução")</span><span class="sxs-lookup"><span data-stu-id="0ff44-427">![Web site running](build-restful-apis-with-aspnet-web-api/_static/image43.png "Web site running")</span></span>

    <span data-ttu-id="0ff44-428">*Site da Web em execução*</span><span class="sxs-lookup"><span data-stu-id="0ff44-428">*Web site running*</span></span>
6. <span data-ttu-id="0ff44-429">Volte para o portal e clique no nome do site da web sob o **nome** coluna para exibir as páginas de gerenciamento.</span><span class="sxs-lookup"><span data-stu-id="0ff44-429">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="0ff44-430">![Abrir as páginas de gerenciamento do site da web](build-restful-apis-with-aspnet-web-api/_static/image44.png "abrir as páginas de gerenciamento do site da web")</span><span class="sxs-lookup"><span data-stu-id="0ff44-430">![Opening the web site management pages](build-restful-apis-with-aspnet-web-api/_static/image44.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="0ff44-431">*Abrir as páginas de gerenciamento do Site da Web*</span><span class="sxs-lookup"><span data-stu-id="0ff44-431">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="0ff44-432">No **Dashboard** página na **visão geral rápida** seção, clique no **baixar perfil de publicação** link.</span><span class="sxs-lookup"><span data-stu-id="0ff44-432">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="0ff44-433">O *perfil de publicação* contém todas as informações necessárias para publicar um aplicativo web para um Azure para cada método de publicação habilitado.</span><span class="sxs-lookup"><span data-stu-id="0ff44-433">The *publish profile* contains all of the information required to publish a web application to a Azure for each enabled publication method.</span></span> <span data-ttu-id="0ff44-434">O perfil de publicação contém as URLs, as credenciais do usuário e cadeias de caracteres de banco de dados necessárias para conectar e autenticar em relação a cada um dos pontos de extremidade para o qual um método de publicação está habilitado.</span><span class="sxs-lookup"><span data-stu-id="0ff44-434">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="0ff44-435">**Microsoft WebMatrix 2**, **Microsoft Visual Studio para Web Express** e **Microsoft Visual Studio 2012** oferecem suporte à leitura perfis de publicação para automatizar a configuração desses programas para publicação de aplicativos web do Azure.</span><span class="sxs-lookup"><span data-stu-id="0ff44-435">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Azure.</span></span>

    <span data-ttu-id="0ff44-436">![Baixando o site da web de perfil de publicação](build-restful-apis-with-aspnet-web-api/_static/image45.png "baixando o site da web de perfil de publicação")</span><span class="sxs-lookup"><span data-stu-id="0ff44-436">![Downloading the web site publish profile](build-restful-apis-with-aspnet-web-api/_static/image45.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="0ff44-437">*Baixando o Site da Web de perfil de publicação*</span><span class="sxs-lookup"><span data-stu-id="0ff44-437">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="0ff44-438">Baixe o arquivo de perfil de publicação em um local conhecido.</span><span class="sxs-lookup"><span data-stu-id="0ff44-438">Download the publish profile file to a known location.</span></span> <span data-ttu-id="0ff44-439">Ainda mais neste exercício, você verá como usar esse arquivo para publicar um aplicativo web do Azure do Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="0ff44-439">Further in this exercise you will see how to use this file to publish a web application to Azure from Visual Studio.</span></span>

    <span data-ttu-id="0ff44-440">![Salvando o arquivo de perfil de publicação](build-restful-apis-with-aspnet-web-api/_static/image46.png "salvar o perfil de publicação")</span><span class="sxs-lookup"><span data-stu-id="0ff44-440">![Saving the publish profile file](build-restful-apis-with-aspnet-web-api/_static/image46.png "Saving the publish profile")</span></span>

    <span data-ttu-id="0ff44-441">*Salvando o arquivo de perfil de publicação*</span><span class="sxs-lookup"><span data-stu-id="0ff44-441">*Saving the publish profile file*</span></span>

<a id="ApxCTask2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="0ff44-442">Tarefa 2 – Configurando o servidor de banco de dados</span><span class="sxs-lookup"><span data-stu-id="0ff44-442">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="0ff44-443">Se seu aplicativo faz uso do SQL Server você precisará criar um servidor de banco de dados SQL de bancos de dados.</span><span class="sxs-lookup"><span data-stu-id="0ff44-443">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="0ff44-444">Se você quiser implantar um aplicativo simples que não usa o SQL Server, você pode ignorar esta tarefa.</span><span class="sxs-lookup"><span data-stu-id="0ff44-444">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="0ff44-445">Você precisará de um servidor de banco de dados SQL para armazenar o banco de dados do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="0ff44-445">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="0ff44-446">Você pode exibir os servidores de banco de dados SQL na sua assinatura no portal de gerenciamento do Azure em **bancos de dados Sql** | **servidores** | **painel do servidor**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-446">You can view the SQL Database servers from your subscription in the Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="0ff44-447">Se você não tiver um servidor criado, você pode criar uma usando o **adicionar** botão na barra de comandos.</span><span class="sxs-lookup"><span data-stu-id="0ff44-447">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="0ff44-448">Anote o **nome do servidor e o URL, o nome de logon de administrador e senha**, pois você usará nas próximas tarefas.</span><span class="sxs-lookup"><span data-stu-id="0ff44-448">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="0ff44-449">Não crie o banco de dados ainda, ele será criado em um estágio posterior.</span><span class="sxs-lookup"><span data-stu-id="0ff44-449">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="0ff44-450">![Painel do servidor de banco de dados SQL](build-restful-apis-with-aspnet-web-api/_static/image47.png "painel de banco de dados do SQL Server")</span><span class="sxs-lookup"><span data-stu-id="0ff44-450">![SQL Database Server Dashboard](build-restful-apis-with-aspnet-web-api/_static/image47.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="0ff44-451">*Painel de banco de dados do SQL Server*</span><span class="sxs-lookup"><span data-stu-id="0ff44-451">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="0ff44-452">A próxima tarefa, você testará a conexão de banco de dados do Visual Studio, por esse motivo, você precisa incluir seu endereço IP local na lista do servidor **endereços IP permitidos**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-452">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="0ff44-453">Para fazer isso, clique em **configurar**, selecione o endereço IP do **endereço de IP do cliente atual** e cole-o na **endereço IP inicial** e **oendereçoIPfinal** caixas de texto e clique em de ![add-client-ip-address-ok-button](build-restful-apis-with-aspnet-web-api/_static/image48.png) botão.</span><span class="sxs-lookup"><span data-stu-id="0ff44-453">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes and click the ![add-client-ip-address-ok-button](build-restful-apis-with-aspnet-web-api/_static/image48.png) button.</span></span>

    ![Adicionar endereço IP do cliente](build-restful-apis-with-aspnet-web-api/_static/image49.png)

    <span data-ttu-id="0ff44-455">*Adicionar endereço IP do cliente*</span><span class="sxs-lookup"><span data-stu-id="0ff44-455">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="0ff44-456">Uma vez a **endereço IP do cliente** é adicionado para endereços IP, clique em **salvar** para confirmar as alterações.</span><span class="sxs-lookup"><span data-stu-id="0ff44-456">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![Confirmar alterações](build-restful-apis-with-aspnet-web-api/_static/image50.png)

    <span data-ttu-id="0ff44-458">*Confirmar alterações*</span><span class="sxs-lookup"><span data-stu-id="0ff44-458">*Confirm Changes*</span></span>

<a id="ApxCTask3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="0ff44-459">Tarefa 3 – publicar um aplicativo ASP.NET MVC 4 usando a implantação da Web</span><span class="sxs-lookup"><span data-stu-id="0ff44-459">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="0ff44-460">Volte para a solução do ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="0ff44-460">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="0ff44-461">No **Gerenciador de soluções**, clique com botão direito no projeto de site da web e selecione **publicar**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-461">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="0ff44-462">![O aplicativo de publicação](build-restful-apis-with-aspnet-web-api/_static/image51.png "publicando o aplicativo")</span><span class="sxs-lookup"><span data-stu-id="0ff44-462">![Publishing the Application](build-restful-apis-with-aspnet-web-api/_static/image51.png "Publishing the Application")</span></span>

    <span data-ttu-id="0ff44-463">*Publicar o site da web*</span><span class="sxs-lookup"><span data-stu-id="0ff44-463">*Publishing the web site*</span></span>
2. <span data-ttu-id="0ff44-464">Importe o perfil de publicação que você salvou na primeira tarefa.</span><span class="sxs-lookup"><span data-stu-id="0ff44-464">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="0ff44-465">![Importando o perfil de publicação](build-restful-apis-with-aspnet-web-api/_static/image52.png "importando o perfil de publicação")</span><span class="sxs-lookup"><span data-stu-id="0ff44-465">![Importing the publish profile](build-restful-apis-with-aspnet-web-api/_static/image52.png "Importing the publish profile")</span></span>

    <span data-ttu-id="0ff44-466">*Importando o perfil de publicação*</span><span class="sxs-lookup"><span data-stu-id="0ff44-466">*Importing publish profile*</span></span>
3. <span data-ttu-id="0ff44-467">Clique em **validar Conexão**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-467">Click **Validate Connection**.</span></span> <span data-ttu-id="0ff44-468">Depois que a validação estiver concluída, clique em **próxima**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-468">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="0ff44-469">A validação é concluída quando você vir uma marca de seleção verde aparecer ao lado do botão Validar Conexão.</span><span class="sxs-lookup"><span data-stu-id="0ff44-469">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="0ff44-470">![Validar conexão](build-restful-apis-with-aspnet-web-api/_static/image53.png "validar conexão")</span><span class="sxs-lookup"><span data-stu-id="0ff44-470">![Validating connection](build-restful-apis-with-aspnet-web-api/_static/image53.png "Validating connection")</span></span>

    <span data-ttu-id="0ff44-471">*Validando a conexão*</span><span class="sxs-lookup"><span data-stu-id="0ff44-471">*Validating connection*</span></span>
4. <span data-ttu-id="0ff44-472">No **as configurações** página na **bancos de dados** seção, clique no botão ao lado da caixa de texto do sua conexão banco de dados (ou seja, **DefaultConnection**).</span><span class="sxs-lookup"><span data-stu-id="0ff44-472">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="0ff44-473">![Configuração de implantação da Web](build-restful-apis-with-aspnet-web-api/_static/image54.png "configuração de implantação da Web")</span><span class="sxs-lookup"><span data-stu-id="0ff44-473">![Web deploy configuration](build-restful-apis-with-aspnet-web-api/_static/image54.png "Web deploy configuration")</span></span>

    <span data-ttu-id="0ff44-474">*Configuração de implantação da Web*</span><span class="sxs-lookup"><span data-stu-id="0ff44-474">*Web deploy configuration*</span></span>
5. <span data-ttu-id="0ff44-475">Configure a conexão de banco de dados da seguinte maneira:</span><span class="sxs-lookup"><span data-stu-id="0ff44-475">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="0ff44-476">No **nome do servidor** digite sua URL de servidor de banco de dados SQL usando o *tcp:* prefixo.</span><span class="sxs-lookup"><span data-stu-id="0ff44-476">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="0ff44-477">Na **nome de usuário** digite seu nome de logon de administrador do servidor.</span><span class="sxs-lookup"><span data-stu-id="0ff44-477">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="0ff44-478">Na **senha** digite sua senha de logon de administrador do servidor.</span><span class="sxs-lookup"><span data-stu-id="0ff44-478">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="0ff44-479">Digite um novo nome de banco de dados, por exemplo: *MVC4SampleDB*.</span><span class="sxs-lookup"><span data-stu-id="0ff44-479">Type a new database name, for example: *MVC4SampleDB*.</span></span>

     <span data-ttu-id="0ff44-480">![Configurando a cadeia de caracteres de conexão de destino](build-restful-apis-with-aspnet-web-api/_static/image55.png "Configurando a cadeia de caracteres de conexão de destino")</span><span class="sxs-lookup"><span data-stu-id="0ff44-480">![Configuring destination connection string](build-restful-apis-with-aspnet-web-api/_static/image55.png "Configuring destination connection string")</span></span>

     <span data-ttu-id="0ff44-481">*Configurando a cadeia de caracteres de conexão de destino*</span><span class="sxs-lookup"><span data-stu-id="0ff44-481">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="0ff44-482">Clique em **OK**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-482">Then click **OK**.</span></span> <span data-ttu-id="0ff44-483">Quando for solicitado a criar o banco de dados, clique em **Sim**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-483">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="0ff44-484">![Criando o banco de dados](build-restful-apis-with-aspnet-web-api/_static/image56.png "criando a cadeia de caracteres de banco de dados")</span><span class="sxs-lookup"><span data-stu-id="0ff44-484">![Creating the database](build-restful-apis-with-aspnet-web-api/_static/image56.png "Creating the database string")</span></span>

    <span data-ttu-id="0ff44-485">*Criando o banco de dados*</span><span class="sxs-lookup"><span data-stu-id="0ff44-485">*Creating the database*</span></span>
7. <span data-ttu-id="0ff44-486">A cadeia de caracteres de conexão que você usará para se conectar ao banco de dados SQL no Windows Azure é mostrada na caixa de texto de Conexão padrão.</span><span class="sxs-lookup"><span data-stu-id="0ff44-486">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="0ff44-487">Clique em **Avançar**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-487">Then click **Next**.</span></span>

    <span data-ttu-id="0ff44-488">![Cadeia de caracteres de Conexão que aponta para o banco de dados SQL](build-restful-apis-with-aspnet-web-api/_static/image57.png "cadeia de caracteres de Conexão que aponta para o banco de dados SQL")</span><span class="sxs-lookup"><span data-stu-id="0ff44-488">![Connection string pointing to SQL Database](build-restful-apis-with-aspnet-web-api/_static/image57.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="0ff44-489">*Cadeia de caracteres de Conexão que aponta para o banco de dados SQL*</span><span class="sxs-lookup"><span data-stu-id="0ff44-489">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="0ff44-490">No **versão prévia** , clique em **publicar**.</span><span class="sxs-lookup"><span data-stu-id="0ff44-490">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="0ff44-491">![Publicando o aplicativo web](build-restful-apis-with-aspnet-web-api/_static/image58.png "publicando o aplicativo web")</span><span class="sxs-lookup"><span data-stu-id="0ff44-491">![Publishing the web application](build-restful-apis-with-aspnet-web-api/_static/image58.png "Publishing the web application")</span></span>

    <span data-ttu-id="0ff44-492">*Publicar o aplicativo da web*</span><span class="sxs-lookup"><span data-stu-id="0ff44-492">*Publishing the web application*</span></span>
9. <span data-ttu-id="0ff44-493">Quando o processo de publicação for concluído, o navegador padrão abrirá o site publicado.</span><span class="sxs-lookup"><span data-stu-id="0ff44-493">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="0ff44-494">![Aplicativo publicado no Windows Azure](build-restful-apis-with-aspnet-web-api/_static/image59.png "aplicativo publicado no Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="0ff44-494">![Application published to Windows Azure](build-restful-apis-with-aspnet-web-api/_static/image59.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="0ff44-495">*Aplicativo publicado no Azure*</span><span class="sxs-lookup"><span data-stu-id="0ff44-495">*Application published to Azure*</span></span>
