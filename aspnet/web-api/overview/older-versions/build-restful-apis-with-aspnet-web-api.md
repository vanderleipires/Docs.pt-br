...
- Implementar uma API da Web RESTful
...
1. [Exercício 1: Criar uma Web API somente leitura](#Exercise1)
...
### <a name="exercise-1-create-a-read-only-web-api"></a>Exercício 1: Criar uma Web API somente leitura

Neste exercício, você irá implementar os métodos GET somente leitura para o gerente do contato.
...
Nesta tarefa, você usará novos modelos de projeto da web do ASP.NET para criar um aplicativo da web API da Web.
...
2. Do **arquivo** menu, selecione **novo projeto**. Selecione o **Visual c# | Web** tipo de exibição de árvore de tipo de projeto do projeto e selecione o **aplicativo Web do ASP.NET MVC 4** tipo de projeto. Defina o projeto **nome** para *ContactManager* e **nome da solução** para *começar*, em seguida, clique em **Okey**.

    ![Criar um novo projeto de aplicativo do ASP.NET MVC 4.0 Web](build-restful-apis-with-aspnet-web-api/_static/image1.png "criar um novo projeto de aplicativo do ASP.NET MVC 4.0 da Web")

    *Criar um novo projeto de aplicativo do ASP.NET MVC 4.0 da Web*
3. No diálogo de tipo de projeto do ASP.NET MVC 4, selecione o **API da Web** tipo de projeto. Clique em **OK**.
...
#### <a name="task-2---creating-the-contact-manager-api-controllers"></a>Tarefa 2: criar os controladores de API do Gerenciador de contato

Nesta tarefa, você criará as classes do controlador no qual residem os métodos de API.

1. Exclua o arquivo chamado **ValuesController.cs** em **controladores** pasta do projeto.
2. Clique com botão direito do **controladores** pasta no projeto e selecione **adicionar | Controlador** no menu de contexto.

    ![Adicionar um novo controlador para o projeto](build-restful-apis-with-aspnet-web-api/_static/image3.png "adicionando um novo controlador ao projeto")

    *Adicionar um novo controlador ao projeto*
...
4. Adicione o seguinte código para o **ContactController**.
    ...
    (Código de trecho - *Web API laboratório - Ex01 - obter método API*)

    [!code-csharp[Main](build-restful-apis-with-aspnet-web-api/samples/sample1.cs)]
5. Pressione **F5** para depurar o aplicativo. A home page padrão para um projeto de API da Web deve aparecer.

    ![A home page do padrão de um aplicativo ASP.NET Web API](build-restful-apis-with-aspnet-web-api/_static/image5.png "a home page do padrão de um aplicativo de API da Web ASP.NET")

    *A home page do padrão de um aplicativo de API da Web ASP.NET*
6. Na janela do Internet Explorer, pressione a **F12** chave para abrir o **ferramentas de desenvolvedor** janela. Clique o **rede** guia e, em seguida, clique no **iniciar captura** botão para começar a capturar o tráfego de rede na janela.

    ![Captura de rede abrindo a guia de rede e iniciar](build-restful-apis-with-aspnet-web-api/_static/image6.png "abrindo a guia de rede e iniciar a captura de rede")

    *Abrir a guia de rede e iniciar a captura de rede*
7. Anexar a URL na barra de endereços do navegador com **/api/contato** e pressione enter. Os detalhes de transmissão aparecerá na janela de captura de rede. Observe que o tipo MIME da resposta é **aplicativo/json**. Isso demonstra como o formato de saída padrão é JSON.
    ...
    *Exibindo a saída da solicitação de API da Web no modo de exibição de rede*
    ...
    > [!NOTE]
    > Comportamento do padrão do Internet Explorer 10 agora será pergunte se o usuário deseja salvar ou abrir o fluxo resultante da chamada à API da Web. A saída será um arquivo de texto que contém o resultado JSON da chamada de URL da API da Web. Não cancele a caixa de diálogo para que possa observar o conteúdo da resposta por meio da janela da ferramenta de desenvolvedores.
8. Clique o **acesse a exibição detalhada** botão para ver mais detalhes sobre a resposta dessa chamada de API.

    ![Alternar para exibição detalhada](build-restful-apis-with-aspnet-web-api/_static/image8.png "alternar para a exibição de detalhes")

    *Alternar para modo de exibição detalhado*
9. Clique o **corpo da resposta** guia para exibir o texto JSON de resposta real.
    ...
    *Exibindo o texto JSON de saída no monitor de rede*
...
2. No **Adicionar Novo Item** caixa de diálogo, nomeie o novo arquivo **Contact.cs** e clique em **adicionar.**
    ...
    ![Criar o novo arquivo de classe do contato](build-restful-apis-with-aspnet-web-api/_static/image11.png "criar o novo arquivo de classe de contato")

    *Criar o novo arquivo de classe de contato*
3. Adicione o seguinte código realçado para o **contato** classe.
...
5. Modifique o código para o **obter** método para que retorne uma matriz de instâncias de modelo do contato.

    (Código de trecho - *Web API laboratório - Ex01 - retornando uma lista de contatos*)
...
#### <a name="task-4---extracting-functionality-into-a-service-layer"></a>Tarefa 4 - extração funcionalidade em uma camada de serviço

Essa tarefa demonstrará como extrair a funcionalidade em uma camada de serviço para tornar mais fácil para os desenvolvedores a separar sua funcionalidade de serviço da camada de controlador, permitindo assim que a capacidade de reutilização dos serviços que, na verdade, fazer o trabalho.

1. Criar uma nova pasta na raiz da solução e nomeie- **serviços**. Para fazer isso, clique com botão direito **ContactManager** projeto, selecione **adicionar** | **nova pasta**, nomeie-o *serviços*.

    ![Criando a pasta serviços de](build-restful-apis-with-aspnet-web-api/_static/image14.png "pasta criando serviços")

    *Criando a pasta de serviços*
2. Clique com botão direito do **serviços** pasta e selecione **adicionar | Classe...**  no menu de contexto.

    ![Adicionando uma nova classe para a pasta serviços](build-restful-apis-with-aspnet-web-api/_static/image15.png "adicionando uma nova classe para a pasta de serviços")

    *Adicionando uma nova classe para a pasta de serviços*
3. Quando o **Adicionar Novo Item** caixa de diálogo for exibida, nomeie a nova classe **ContactRepository** e clique em **adicionar**.
...
9. Alterar o **obter** método para que ele faz uso do serviço de repositório de contato.

    (Código de trecho - *Web API laboratório - Ex01 - retornando uma lista de contatos por meio do repositório*)
...
18. Volte para o Internet Explorer se ele não ainda estiver em foco. Observe a janela de captura de rede.
    ...
    ![Modo de exibição no Internet Explorer, mostrando os resultados da chamada de API da Web de rede](build-restful-apis-with-aspnet-web-api/_static/image19.png "exibição no Internet Explorer, mostrando os resultados da chamada de API da Web de rede")

    *Exibição de rede no Internet Explorer, mostrando os resultados da chamada de API da Web*
19. Clique o **acesse a exibição detalhada** botão.
20. Clique o **corpo da resposta** guia. Observe a saída JSON da chamada de API e como ele representa dois contatos recuperados pela camada de serviço.

    ![Exibindo a saída JSON da API da Web na janela de ferramentas de desenvolvedor](build-restful-apis-with-aspnet-web-api/_static/image20.png "exibindo a saída JSON da API da Web na janela de ferramentas de desenvolvedor")

    *Exibindo a saída JSON da API da Web na janela de ferramentas de desenvolvedor*
...
Neste exercício, você irá implementar POST e PUT métodos para o Gerenciador de contato para habilitá-lo com recursos de edição de dados.

<a id="Ex2Task1"></a>

<a id="Task_1_-_Opening_the_Web_API_Project"></a>
#### <a name="task-1---opening-the-web-api-project"></a>Tarefa 1: abrir o projeto de API da Web

Nesta tarefa, você vai preparar para aprimorar o projeto de API da Web criado no Exercício 1 para que ele possa aceitar a entrada do usuário.
...
#### <a name="task-2---adding-data-persistence-features-to-the-contact-repository-implementation"></a>Tarefa 2: adicionando recursos de persistência de dados para a implementação do repositório de contato

Nesta tarefa, você irá aumentar a classe ContactRepository do projeto de API da Web criado no Exercício 1 para que ele possa manter e aceitar entrada do usuário e as novas instâncias de contato.

1. Adicione a seguinte constante para o **ContactRepository** classe que representa o nome do web server cache item chave posteriormente neste exercício.

    [!code-csharp[Main](build-restful-apis-with-aspnet-web-api/samples/sample9.cs)]
2. Adicione um construtor para o **ContactRepository** que contém o código a seguir.

    (Código de trecho - *Web API laboratório - Ex02 - repositório contato construtor*)

    [!code-csharp[Main](build-restful-apis-with-aspnet-web-api/samples/sample10.cs)]
3. Modifique o código para o **GetAllContacts** método conforme demonstrado abaixo.

    (Código de trecho - *Web API laboratório - Ex02 - obter todos os contatos*)
...
4. Implementar um novo método chamado **SaveContact** para o **ContactRepository** classe para realizar o trabalho de salvar um contato. O **SaveContact** método deve adotar uma única **contato** valor de parâmetro e retornar um valor booleano indicando êxito ou falha.

    (Código de trecho - *Web API laboratório - Ex02 - Implementando o método SaveContact*)
...
Neste exercício, você criará um cliente HTML para chamar a API da Web. Este cliente facilitará a troca de dados com a API da Web usando JavaScript e exibirá os resultados em um navegador da web usando a marcação HTML.

<a id="Ex3Task1"></a>

<a id="Task_1_-_Modifying_the_Index_View_to_Provide_a_GUI_for_Displaying_Contacts"></a>
#### <a name="task-1---modifying-the-index-view-to-provide-a-gui-for-displaying-contacts"></a>Tarefa 1 - modificar a exibição do índice para fornecer uma interface gráfica do usuário para exibir contatos

Nesta tarefa, você modificará a exibição de índice padrão do aplicativo da web para dar suporte a necessidade de exibir a lista de contatos existentes em um navegador HTML.
...
7. Colocar um ponto de interrupção no **obter** método o **ContactController** classe.
    ...
    ![Colocar um ponto de interrupção no método Get do controlador API](build-restful-apis-with-aspnet-web-api/_static/image21.png "colocar um ponto de interrupção no método Get do controlador API")

    *Colocar um ponto de interrupção no método Get do controlador API*
...
9. Depois que a página for carregada e o JavaScript é executado, o ponto de interrupção será atingido e pausa a execução de código no controlador.

    ![Depurar para as chamadas de API da Web usando o VS Express para Web](build-restful-apis-with-aspnet-web-api/_static/image22.png "depurar para as chamadas de API da Web usando o VS Express para Web")

    *Depurar para a chamada de API da Web usando o Visual Studio 2012 Express para Web*
10. Remover o ponto de interrupção e pressione **F5** ou depuração da barra de ferramentas **continuar** botão para continuar a carregar o modo de exibição no navegador. Após a conclusão da chamada à API da Web você verá os contatos retornados da API da Web chamar exibidas como itens de lista no navegador.

    ![Resultados da chamada de API exibida no navegador, como itens de lista](build-restful-apis-with-aspnet-web-api/_static/image23.png "resultados da chamada de API exibida no navegador, como itens de lista")

    *Resultados da chamada de API exibida no navegador, como itens de lista*
11. Pare a depuração.

<a id="Ex3Task2"></a>

<a id="Task_2_-_Modifying_the_Index_View_to_Provide_a_GUI_for_Creating_Contacts"></a>
#### <a name="task-2---modifying-the-index-view-to-provide-a-gui-for-creating-contacts"></a>Tarefa 2: modificar a exibição do índice para fornecer uma interface gráfica para criação de contatos

Nesta tarefa, você continuará modificar a exibição do índice do aplicativo MVC. Um formulário será adicionado à página HTML que capturar a entrada do usuário e enviá-lo para a API da Web para criar um novo contato e será criado um novo método de controlador de API da Web para coletar data a partir da GUI.

1. Abra o **ContactController.cs** arquivo.
2. Adicionar um novo método para a classe do controlador denominada **Post** conforme mostrado no código a seguir.
...
6. Em **ContactController.cs**, coloque um ponto de interrupção no **Post** método.
7. Pressione **F5** para executar o aplicativo no navegador.
8. Depois que a página for carregada no navegador, digite um novo nome de contato e Id e clique no **salvar** botão.

    ![O documento de cliente HTML carregado do navegador](build-restful-apis-with-aspnet-web-api/_static/image24.png "o documento de cliente HTML carregado do navegador")

    *Carregar o documento HTML do cliente no navegador*
9. Quando a janela de depurador quebras no **Post** método, examinar as propriedades do **entre em contato com** parâmetro. Os valores devem corresponder os dados inseridos no formulário.
...
![Usando trechos de código do Visual Studio para inserir o código no seu projeto](build-restful-apis-with-aspnet-web-api/_static/image28.png "trechos de código com o Visual Studio para inserir código em seu projeto")
...
### <a name="to-add-a-code-snippet-using-the-keyboard-c-only"></a>Para adicionar um trecho de código usando o teclado (apenas c#)
...
5. Pressione a tecla Tab duas vezes para inserir o trecho de código no local do cursor.
    ...
    ![Comece a digitar o nome do fragmento](build-restful-apis-with-aspnet-web-api/_static/image29.png "comece a digitar o nome do trecho de código")
    ...
    *Pressione Tab para selecionar o trecho de código realçado*
    ...
    ![Pressione Tab novamente e o trecho expandirá](build-restful-apis-with-aspnet-web-api/_static/image31.png "expandirá pressione Tab novamente e o trecho de código")
...
3. Selecione o trecho relevante na lista, clicando nele.
    ...
    ![Com o botão direito em que você deseja inserir o trecho de código e selecione Inserir trecho](build-restful-apis-with-aspnet-web-api/_static/image32.png "com o botão direito em que você deseja inserir o trecho de código e selecione Inserir trecho")

    *Clique com botão direito em que você deseja inserir o trecho de código e selecione Inserir trecho*

    ![Selecione o trecho relevante na lista, clicando nele](build-restful-apis-with-aspnet-web-api/_static/image33.png "escolher o trecho relevante na lista, clicando nele")
...
## <a name="appendix-c-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a>Apêndice c: publicar um aplicativo ASP.NET MVC 4 usando a implantação da Web
...
2. Clique em **novo** na barra de comandos.
    ...
    ![Criando um novo Site](build-restful-apis-with-aspnet-web-api/_static/image40.png "criar um novo Site")
...
3. Clique em **de computação** | **Site da Web**. Em seguida, selecione **criação rápida** opção. Forneça uma URL disponível para o novo site e clique em **Criar Site**.
    ...
    ![Criando um novo Site usando a criação rápida](build-restful-apis-with-aspnet-web-api/_static/image41.png "criar um novo Site usando a criação rápida")
...
5. Depois que o Site da Web é criado, clique no link sob a **URL** coluna. Verifique se o novo Site da Web está funcionando.
    ...
    ![Navegando para o novo site](build-restful-apis-with-aspnet-web-api/_static/image42.png "navegando para o novo site")

    *Navegando para o novo site*

    ![Site da Web em execução](build-restful-apis-with-aspnet-web-api/_static/image43.png "site em execução")
...
6. Acesse o portal e clique no nome do site sob o **nome** coluna para exibir as páginas de gerenciamento.
    ...
    ![Abrir as páginas de gerenciamento do site da web](build-restful-apis-with-aspnet-web-api/_static/image44.png "abrir páginas de gerenciamento do site")
...
7. No **painel** página no **visão rápida** seção, clique o **baixar perfil de publicação** link.
    ...
    > [!NOTE]
    > O *perfil de publicação* contém todas as informações necessárias para publicar um aplicativo web para um Azure para cada método de publicação habilitado. O perfil de publicação contém as URLs, as credenciais do usuário e cadeias de caracteres de banco de dados necessárias para se conectar e autenticar cada um dos pontos de extremidade para o qual um método de publicação está habilitado. **Microsoft WebMatrix 2**, **Microsoft Visual Studio para Web Express** e **Microsoft Visual Studio 2012** oferecem suporte à leitura perfis de publicação para automatizar a configuração desses programas para Publicando aplicativos web no Azure.
...
1. Volte para a solução do ASP.NET MVC 4. No **Solution Explorer**, com o botão direito no projeto de site da web e selecione **publicar**.
    ...
    ![Publicar o aplicativo](build-restful-apis-with-aspnet-web-api/_static/image51.png "a publicação do aplicativo")

    *Publicar o site*
2. Importe o perfil de publicação que você salvou na primeira tarefa.

    ![Importar o perfil de publicação](build-restful-apis-with-aspnet-web-api/_static/image52.png "importar o perfil de publicação")
...
3. Clique em **validar Conexão**. Quando a validação estiver concluída, clique em **próximo**.
    ...
    ![Validando a conexão](build-restful-apis-with-aspnet-web-api/_static/image53.png "validação de conexão")
...
8. No **visualização** , clique em **publicar**.
    ...
    ![Publicar o aplicativo web](build-restful-apis-with-aspnet-web-api/_static/image58.png "publicar o aplicativo web")
