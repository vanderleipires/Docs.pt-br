...
Na API da Web do ASP.NET, você pode usar os atributos de [DataAnnotations](https://msdn.microsoft.com/en-us/library/system.componentmodel.dataannotations.aspx) namespace para definir as regras de validação para propriedades em seu modelo. Considere o seguinte modelo:
