...
Se você preferir usar [formato de data do Microsoft JSON](https://msdn.microsoft.com/en-us/library/bb299886.aspx#intro_to_json_sidebarb) (`"\/Date(ticks)\/"`) em vez de ISO 8601, definir o **DateFormatHandling** propriedade nas configurações do serializador:
