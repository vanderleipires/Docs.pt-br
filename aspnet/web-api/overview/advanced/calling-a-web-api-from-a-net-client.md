...
Em vez de usar os formatadores padrão, você pode fornecer uma lista dos formatadores para o **ReadAsAsync** método.  Usando uma lista de formatadores é útil se você tiver um formatador personalizado do tipo de mídia:
