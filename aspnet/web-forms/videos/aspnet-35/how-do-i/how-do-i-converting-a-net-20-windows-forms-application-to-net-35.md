...
Usando o novo recurso do Visual Studio 2008 multiplataforma, demonstrarei atualizando um projeto do .NET 2.0 para .NET 3.5. Neste vídeo, vamos tomar um aplicativo do .NET 2.0 Windows forms e atualizá-lo para .NET 3.5.
