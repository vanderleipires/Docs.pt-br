...
---
<a name="using-script-combining-to-improve-ajax-performance"></a>Usando a combinação de Script para melhorar o desempenho do AJAX
====================
Betrand Le Roy descreve como melhorar o desempenho de um aplicativo Ajax usando um novo recurso chamado combinar o Script, utilizando uma página simples com o código de exemplo do Kit de ferramentas Ajax.
