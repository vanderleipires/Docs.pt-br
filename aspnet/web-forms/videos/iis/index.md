...
- [Trabalhando com IIS7 delegado Admin](working-with-iis7-deligated-admin.md)
- [Gerenciamento de recurso específico delegado](feature-specific-delegated-management.md)
- [Solucionando problemas de aplicativos ASP.NET de produção](troubleshooting-production-aspnet-apps.md)
- [Criando um Site com o Gerenciador de IIS7](creating-a-site-with-iis7-manager.md)
- [Instalando FTP7](installing-ftp7.md)
- [Limitação de taxa de bits](bit-rate-throttling.md)
