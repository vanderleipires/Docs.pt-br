...
ms.locfileid: "30882436"
---
<a name="how-do-i-linq-to-sql-querying-the-database"></a>[Como fazer:] O LINQ to SQL: consulta o banco de dados
====================
por [Scott Stanfield](https://github.com/scottstanfield)

Este vídeo mostra como consultar um banco de dados com LINQ, o SQL subjacente com um visualizador de consulta, a associação de dados com controles do ASP.NET e paginação de registro.
