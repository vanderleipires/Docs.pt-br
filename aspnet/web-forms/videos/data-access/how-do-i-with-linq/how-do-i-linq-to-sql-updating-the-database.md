...
ms.locfileid: "37367455"
---
<a name="how-do-i-linq-to-sql-updating-the-database"></a>[Como fazer:] LINQ to SQL: atualizando o banco de dados
====================
por [Scott Stanfield](https://github.com/scottstanfield)

Neste vídeo, demonstrei como criar, atualizar e excluir registros por meio de LINQ, transações simples, atualizações em relações e validação de linha e coluna personalizada.
