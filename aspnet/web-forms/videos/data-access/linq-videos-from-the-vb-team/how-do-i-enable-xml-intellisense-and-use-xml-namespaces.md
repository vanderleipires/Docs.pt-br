...
---
<a name="how-do-i-enable-xml-intellisense-and-use-xml-namespaces"></a>[Como fazer:] Habilitar o IntelliSense XML e usar Namespaces XML?
====================
por [Beth Massi](https://github.com/bethmassi)

Os desenvolvedores do Visual Basic aprenderá como habilitar o IntelliSense XML usando esquemas e como os namespaces XML são usadas ao consultar e criação de documentos XML.
