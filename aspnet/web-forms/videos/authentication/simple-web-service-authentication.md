...
---
<a name="simple-web-service-authentication"></a>Autenticação de serviço Web simples
====================
por [Joe Stagner](https://github.com/JoeStagner)

Neste vídeo, Joe Stagner demonstra mecanismos diferentes que podem ser adicionados a um aplicativo ASP.NET para restringir o acesso não autorizado a serviços web ASMX.

[&#9654;Assista ao vídeo (54 minutos)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/simple-web-service-authentication)
