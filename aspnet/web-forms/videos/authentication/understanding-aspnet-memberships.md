...
---
<a name="understanding-aspnet-memberships"></a>Noções básicas sobre as associações do ASP.NET
====================
por [Joe Stagner](https://github.com/JoeStagner)

Neste vídeo, Joe Stagner examina trabalhando com os provedores internos disponíveis para desenvolvedores do ASP.NET, para a associação. Para obter informações adicionais sobre este vídeo, leia o [criar o esquema de associação no SQL Server](../../overview/older-versions-security/membership/creating-the-membership-schema-in-sql-server-vb.md) tutorial de segurança.
