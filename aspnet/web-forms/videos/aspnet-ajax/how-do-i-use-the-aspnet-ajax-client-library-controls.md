...
Demonstra a experiência de programação do lado do cliente usando scripts e controles da biblioteca de cliente do ASP.NET AJAX. Os controles de cliente adicionam ações, comportamentos e associações de dados para a experiência de interface do usuário do lado do cliente.
