...
Neste vídeo, você aprenderá como adicionar as atualizações dinâmicas de página parcial para seu aplicativo ASP.NET usando o Microsoft ASP.NET AJAX. Em particular, você verá como usar o TimerControl para gerenciar a frequência dos retornos de chamada AJAX.
