...
Crie uma página da web para coletar informações do usuário com o controle Wizard, validar essas informações e usar as classes de mail para enviar uma mensagem de email de confirmação.
