...
---
<a name="aspnet-4-quick-hit---clean-webconfig-files"></a>O ASP.NET 4 "rápida" ocorrências - Limpar arquivos Web. config
====================
por [Joe Stagner](https://github.com/JoeStagner)

Neste vídeo, você verá como os elementos de configuração importantes foram movidos para o arquivo Machine. config. Isso permite que o arquivo Web. config em aplicativos ASP.NET 4 para estar vazio ou conter um número mínimo de linhas.
