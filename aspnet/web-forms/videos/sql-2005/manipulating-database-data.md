...
Iniciantes do SQL Server aprenderá sobre objetos do ADO.NET e a execução da instrução SQL do ADO.NET. Explore SQL e saiba mais sobre instruções delete, update e insert.
