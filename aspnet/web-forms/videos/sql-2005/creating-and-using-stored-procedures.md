...
---
<a name="creating-and-using-stored-procedures"></a>Criando e usando procedimentos armazenados
====================
por [Microsoft](https://github.com/microsoft)

Este vídeo expande o tópico de procedimentos armazenados que foi introduzida várias lições atrás. Neste vídeo, explicamos a sintaxe básica para criar e atualizar os procedimentos armazenados, usando os parâmetros de entrada e saídos, valores de retorno, declarando variáveis e adicionando outros elementos de programação do T-SQL em procedimentos armazenados, como executar procedimentos armazenados Na janela de consulta e, finalmente, a sintaxe do Visual Basic e c# necessárias para utilizar procedimentos armazenados em seus próprios aplicativos.

[&#9654;Assista ao vídeo (minutos 42)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/creating-and-using-stored-procedures)
