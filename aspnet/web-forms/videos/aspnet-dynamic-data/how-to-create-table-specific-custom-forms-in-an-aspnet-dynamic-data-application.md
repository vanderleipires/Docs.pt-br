...
Às vezes precisamos desviar do padrão da interface do usuário no nosso aplicativo de dados dinâmicos do ASP.NET. Este vídeo veremos como é possível fazer isso e como podemos desativar a geração automática coluna e construir um formulário da web que exibe apenas os dados que selecionamos especificamente.
