...
Neste vídeo, podemos ver uma demonstração da variedade de opções disponíveis para configurar a aparência e o comportamento do controle do extensor de calendário do Kit de ferramentas de controle AJAX ASP.NET.
