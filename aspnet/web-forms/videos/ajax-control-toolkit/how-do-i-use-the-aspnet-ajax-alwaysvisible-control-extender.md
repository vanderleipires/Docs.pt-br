...
Veja como é fácil âncora de um elemento de página para uma posição na tela, em que ele sempre permanece visível independentemente de quanto o usuário pode rolar o documento. O elemento de página flutuante pode ser tanto um texto estático em uma caixa de ajuda baseados em AJAX, reconhecimento de contexto.
