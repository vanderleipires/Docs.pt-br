...
Saiba como o controle do extensor PasswordStrength fornece comentários imediato e dinâmicos para os usuários sobre a intensidade das suas senhas escolhidas. Os comentários podem ser um aviso de texto, gráficos de barras indicador ou uma combinação de ambos.
