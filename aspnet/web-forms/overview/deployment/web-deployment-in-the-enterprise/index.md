...
---
<a name="aspnet-4---enterprise-deployment-series-1"></a>ASP.NET 4 - Enterprise implantação série 1
====================
...
- [Implantação da Web da empresa](web-deployment-in-the-enterprise.md)
...
- [Criando e executando um arquivo de comando de implantação](creating-and-running-a-deployment-command-file.md)
- [Instalando manualmente os pacotes da Web](manually-installing-web-packages.md)
