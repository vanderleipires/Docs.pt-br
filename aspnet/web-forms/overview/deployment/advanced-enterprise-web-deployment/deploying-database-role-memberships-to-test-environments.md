...
- Se você estiver executando uma implantação "e se"&#x2014;em outras palavras, se você estiver gerando scripts de implantação, mas na verdade não executá-los&#x2014;você não deve executar o script SQL.
