...
---
<a name="creating-a-custom-ajax-control-toolkit-control-extender-c"></a>Criando um extensor de controle do Kit de ferramentas de controle AJAX personalizados (c#)
====================
...
**Figura 01**: solução com o projeto de biblioteca de classe e de site ([clique para exibir a imagem em tamanho normal](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image9.png))
...
Depois de concluir essas etapas, sua pasta de referências de projeto de biblioteca de classe deve parecer com a Figura 2.
...
**Figura 02**: pasta de referências com as referências necessárias ([clique para exibir a imagem em tamanho normal](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image12.png))
...
**Listando 1 - MyCustomExtender.cs**
...
**A listagem 2 - DisabledButtonExtender.cs**
...
**Figura 03**: adicionando um arquivo JavaScript como um recurso incorporado ([clique para exibir a imagem em tamanho normal](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image15.png))
...
**A listagem 4 - DisabledButtonDesigner.cs**
...
5. Na janela Propriedades, altere a propriedade de ID de botões para o valor *btnSave* e a propriedade de texto como o valor *salvar\**.
...
**Figura 05**: caixa de diálogo do Assistente de extensor ([clique para exibir a imagem em tamanho normal](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image21.png))
...
[![Definindo propriedades estendidas](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image23.png)](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image22.png)

**Figura 06**: definindo as propriedades estendidas ([clique para exibir a imagem em tamanho normal](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image24.png))
