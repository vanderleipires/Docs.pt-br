...
---
<a name="executing-several-animations-after-each-other-vb"></a>Executar várias animações após o outro (VB)
====================
...
[![Primeiro aumenta a largura](executing-several-animations-after-each-other-vb/_static/image2.png)](executing-several-animations-after-each-other-vb/_static/image1.png)

Primeiro aumenta a largura ([clique para exibir a imagem em tamanho normal](executing-several-animations-after-each-other-vb/_static/image3.png))
