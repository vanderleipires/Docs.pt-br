...
![Quando ocorre uma exceção sem tratamento, o usuário final verá uma página de erro](handling-bll-and-dal-level-exceptions-cs/_static/image7.png)
...
[![Uma mensagem de erro será exibida se um usuário omite um campo necessário](handling-bll-and-dal-level-exceptions-cs/_static/image9.png)](handling-bll-and-dal-level-exceptions-cs/_static/image8.png)

**Figura 4**: uma mensagem de erro será exibida se um usuário omite um campo necessário ([clique para exibir a imagem em tamanho normal](handling-bll-and-dal-level-exceptions-cs/_static/image10.png))
