...
ms.locfileid: "41824394"
---
<a name="paging-and-sorting-report-data-vb"></a>Paginação e classificação de dados do relatório (VB)
====================
...
**Figura 8**: com paginação habilitado, somente um subconjunto de registros são exibidos por vez ([clique para exibir a imagem em tamanho normal](paging-and-sorting-report-data-vb/_static/image14.png))
...
**Figura 14**: ao remover a propriedade SortExpression, os usuários não podem classificar produtos pelo preço ([clique para exibir a imagem em tamanho normal](paging-and-sorting-report-data-vb/_static/image30.png))
...
**Figura 15**: clique no botão ordena a produtos da mais cara para o menos ([clique para exibir a imagem em tamanho normal](paging-and-sorting-report-data-vb/_static/image33.png))
