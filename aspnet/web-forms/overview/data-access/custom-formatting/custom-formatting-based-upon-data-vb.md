...
**Figura 2**: O DetailsView exibe um produto de controle por vez ([clique para exibir a imagem em tamanho normal](custom-formatting-based-upon-data-vb/_static/image6.png))
