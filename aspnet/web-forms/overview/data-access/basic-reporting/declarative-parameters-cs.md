...
**Figura 8**: defina o valor de parâmetro para o `CountryName` o valor de controle ([clique para exibir a imagem em tamanho normal](declarative-parameters-cs/_static/image24.png))
