...
Para percorrer a instrução de um procedimento armazenado por vez, clique no botão Avançar na barra de ferramentas ou pressione a tecla F10. O `Products_SelectByCategoryID` procedimento armazenado contiver um único `SELECT` instrução, portanto, atingir F10 percorrerá as etapas para a instrução única e concluir a execução do procedimento armazenado. Após o procedimento armazenado, sua saída será exibida na janela de saída e o depurador será encerrado.
...
**Figura 7**: s o procedimento armazenado ponto de interrupção foi atingido ([clique para exibir a imagem em tamanho normal](debugging-stored-procedures-cs/_static/image17.png))
