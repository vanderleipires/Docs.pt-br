...
A primeira linha na marcação declarativa é o [ `@Master` diretiva](https://msdn.microsoft.com/library/ms228176.aspx). O `@Master` diretiva é semelhante do [ `@Page` diretiva](https://msdn.microsoft.com/library/ydy4x04a.aspx) que aparece nas páginas do ASP.NET. Define o idioma do servidor (c#) e informações sobre o local e a herança de classe de code-behind da página mestra.
