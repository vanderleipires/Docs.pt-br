...
No [ *criando um Layout de todo o Site usando páginas mestras* ](creating-a-site-wide-layout-using-master-pages-vb.md) tutorial adicionamos um `<link>` para o `Styles.css` arquivo no `<head>` região:
