...
O ASP.NET 2.0 introduziu um número de *serviços de aplicativo*, que são um conjunto de serviços de bloco de construção que você pode adicionar ao seu aplicativo web. Adicionamos os serviços de associação e funções para o site do catálogo revisões de volta a [ *Configurando um site que usa serviços de aplicativos* tutorial](configuring-a-website-that-uses-application-services-vb.md). O serviço de associação facilita criando e gerenciando contas de usuário. o serviço de funções oferece uma API para categorizar os usuários em grupos. O site de revisões de livros tem três contas de usuário - Scott, Jisun e Alice - e uma única função de administrador, com Scott e Jisun na função de administrador.
...
([Clique para exibir a imagem em tamanho normal](users-and-roles-on-the-production-website-vb/_static/image6.png))
...
([Clique para exibir a imagem em tamanho normal](users-and-roles-on-the-production-website-vb/_static/image9.png))
...
([Clique para exibir a imagem em tamanho normal](users-and-roles-on-the-production-website-vb/_static/image12.png))
...
No [ *Configurando um site que usa serviços de aplicativos* tutorial](configuring-a-website-that-uses-application-services-vb.md) adicionei uma página para o `Admin` pasta denominada `CreateAccount.aspx`. Esta página permite que um administrador para adicionar uma nova conta de usuário para o site e especificar se é ou não o usuário recém-criado na função de administrador (consulte **Figura 5**).
...
([Clique para exibir a imagem em tamanho normal](users-and-roles-on-the-production-website-vb/_static/image15.png))
