...
**Figura 5**: A mestre com todos os controles de ContentPlaceHolder. Observe que a altura da célula para a célula de cabeçalho é agora o que deve ser
...
**Figura 7**: definir um controle de conteúdo como padrão para o conteúdo de páginas mestras
