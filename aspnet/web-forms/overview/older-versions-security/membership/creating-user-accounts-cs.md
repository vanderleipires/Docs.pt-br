...
- [`CreateUserWizardStep`](https://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.createuserwizardstep.aspx)– processa a interface para coletar informações sobre como criar a nova conta de usuário. Esta é a etapa mostrada na Figura 11.
