...
- [`CreateUserWizardStep`](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizardstep.aspx) ? renderiza a interface para coletar informações sobre como criar a nova conta de usuário. Esta é a etapa mostrada na Figura 11.
