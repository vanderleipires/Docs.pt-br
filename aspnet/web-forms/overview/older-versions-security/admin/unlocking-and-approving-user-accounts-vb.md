...
title: Desbloquear e aprovar as contas de usuário (VB) | Microsoft Docs
...
- Um controle de rótulo Web para exibir o nome do usuário selecionado. Definir este rótulo `ID` para `UserNameLabel` e limpar sua propriedade Text.
...
[![Criar Interface do usuário para UserInformation.aspx](unlocking-and-approving-user-accounts-vb/_static/image5.png)](unlocking-and-approving-user-accounts-vb/_static/image4.png)
...
[![Carlos foi reprovado](unlocking-and-approving-user-accounts-vb/_static/image8.png)](unlocking-and-approving-user-accounts-vb/_static/image7.png)
...
[![Carlos não é possível porque His conta de logon é reprovado](unlocking-and-approving-user-accounts-vb/_static/image11.png)](unlocking-and-approving-user-accounts-vb/_static/image10.png)

**Figura 4**: Chris não é possível porque His conta de logon é reprovado ([clique para exibir a imagem em tamanho normal](unlocking-and-approving-user-accounts-vb/_static/image12.png))
...
**Figura 5**: Dave tem foi bloqueada fora do sistema ([clique para exibir a imagem em tamanho normal](unlocking-and-approving-user-accounts-vb/_static/image15.png))
...
Definir o `MailDefinition`do `BodyFileName` propriedade como "~ / EmailTemplates/CreateUserWizard.txt" e seu `Subject` propriedade como "Bem-vindo ao meu site! Ative sua conta".
...
**Figura 7**: conta de usuário nova a é agora aprovada ([clique para exibir a imagem em tamanho normal](unlocking-and-approving-user-accounts-vb/_static/image21.png))
