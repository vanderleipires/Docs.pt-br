...
- [Visão geral de implantação de Web do Visual Studio e ASP.NET](https://msdn.microsoft.com/library/dd394698.aspx) (MSDN).
...
- [Como: implantar um Web projeto usando um clique para publicar no Visual Studio](https://msdn.microsoft.com/library/dd465337.aspx) (informações de referência para o Assistente de publicação do Visual Studio Web.)
...
- [Como: instalar um pacote de implantação usando o arquivo Deploy criado pelo Visual Studio](https://msdn.microsoft.com/library/ff356104.aspx) (MSDN).
...
- [Sintaxe de transformação do Web. config para implantação de projeto da Web usando o Visual Studio](https://msdn.microsoft.com/library/dd465326.aspx) (MSDN).
...
- [Como desabilitar a transformação Web. config?](https://msdn.microsoft.com/library/ee942158.aspx#disable_web_config_transformation) (MSDN).
...
- [Configurando a implantação de banco de dados no Visual Studio](https://msdn.microsoft.com/library/dd394698.aspx#dbdeployment) (MSDN). Visão geral das opções para implantar um banco de dados com um projeto da web.
...
- [Como: implantar um projeto usando um clique publica no Visual Studio](https://msdn.microsoft.com/library/dd465337.aspx) (MSDN).
...
- [Migrando bancos de dados para o banco de dados de SQL do Windows Azure (antigo SQL Azure)](https://msdn.microsoft.com/library/windowsazure/ee730904.aspx) (MSDN).
...
- [Pacote/publicar na guia Web, propriedades de projeto](https://msdn.microsoft.com/library/dd410108.aspx) (MSDN).
...
- [Como criar um Site da Intranet usando o ASP.NET MVC](https://msdn.microsoft.com/library/gg703322(VS.98).aspx) (MSDN). Writen mais antiga do passo a passo para o Visual Studio 2010, não reflete alterações importantes nos modelos de projeto de intranet introduzidos no Visual Studio 2013.
...
- [Perguntas Frequentes de implantação para Visual Studio e ASP.NET Web](https://msdn.microsoft.com/library/ee942158.aspx) (MSDN).
