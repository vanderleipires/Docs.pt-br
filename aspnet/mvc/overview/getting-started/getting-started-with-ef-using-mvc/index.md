...
- [Resiliência de Conexão e comando interceptação](connection-resiliency-and-command-interception-with-the-entity-framework-in-an-asp-net-mvc-application.md)
- [Implantação e migrações primeiro código](migrations-and-deployment-with-the-entity-framework-in-an-asp-net-mvc-application.md)
...
- [Async e procedimentos armazenados](async-and-stored-procedures-with-the-entity-framework-in-an-asp-net-mvc-application.md)
