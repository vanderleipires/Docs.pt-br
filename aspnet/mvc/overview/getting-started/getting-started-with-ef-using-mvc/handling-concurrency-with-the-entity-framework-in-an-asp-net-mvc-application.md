...
Clique em **Salvar** novamente. O valor digitado na segunda guia do navegador é salva com o valor original dos dados alterados no navegador primeiro. Você verá os valores salvos quando a página Índice for exibida.
