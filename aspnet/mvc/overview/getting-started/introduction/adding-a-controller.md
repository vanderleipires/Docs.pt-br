...
> [!NOTE]
> Na etapa anterior, o padrão MVC modelo foi selecionado. Isso cria Home, conta e gerenciar controladores por padrão.
...
> [!NOTE]
> Observação de segurança: O código acima usa [HttpUtility](https://msdn.microsoft.com/en-us/library/ee360286(v=vs.110).aspx) para proteger o aplicativo contra entrada mal-intencionada (ou seja, o JavaScript). Para obter mais informações, consulte [como: proteger contra scripts maliciosos em um aplicativo da Web aplicando codificação HTML a cadeias de caracteres](https://msdn.microsoft.com/en-us/library/a2a4yykt(v=vs.100).aspx).
