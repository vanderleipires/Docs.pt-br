...
====================
> <span data-ttu-id="93300-104">Tópicos avançados de programação ASP.NET MVC, incluindo internacionalização, extensibilidade e a acessibilidade.</span><span class="sxs-lookup"><span data-stu-id="93300-104">Advanced topics for programming ASP.NET MVC, including accessibility, extensibility, and internationalization.</span></span>


- [<span data-ttu-id="93300-105">Modelo MVC personalizado</span><span class="sxs-lookup"><span data-stu-id="93300-105">Custom MVC Template</span></span>](custom-mvc-templates.md)
