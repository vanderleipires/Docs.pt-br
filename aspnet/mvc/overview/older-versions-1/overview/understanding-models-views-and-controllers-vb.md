...
[![Criar caixa de diálogo de teste de unidade](understanding-models-views-and-controllers-vb/_static/image2.jpg)](understanding-models-views-and-controllers-vb/_static/image3.png)

**Figura 02**: Criar diálogo de teste de unidade ([clique para exibir a imagem em tamanho normal](understanding-models-views-and-controllers-vb/_static/image4.png))
...
Se você expandir a pasta controladores, você verá um arquivo chamado AccountController.vb e um arquivo chamado HomeController.vb. Se você expandir a pasta de modos de exibição, você deve ver três subpastas nomeadas conta, início e compartilhado. Se você expandir a pasta base, você verá dois arquivos adicionais denominados About e Index.aspx (consulte a Figura 3). Esses arquivos fazem parte do aplicativo de exemplo incluído com o modelo do ASP.NET MVC padrão.


[![A janela do Gerenciador de soluções](understanding-models-views-and-controllers-vb/_static/image3.jpg)](understanding-models-views-and-controllers-vb/_static/image5.png)

**Figura 03**: A janela do Gerenciador de soluções ([clique para exibir a imagem em tamanho normal](understanding-models-views-and-controllers-vb/_static/image6.png))
...
[![Depurando a caixa de diálogo não ativada](understanding-models-views-and-controllers-vb/_static/image4.jpg)](understanding-models-views-and-controllers-vb/_static/image7.png)

**Figura 04**: caixa de diálogo de depuração não habilitada ([clique para exibir a imagem em tamanho normal](understanding-models-views-and-controllers-vb/_static/image8.png))
...
Um controlador é apenas uma classe (por exemplo, uma classe do Visual Basic ou c#). O exemplo de aplicativo ASP.NET MVC inclui um controlador chamado HomeController.vb localizado na pasta controladores. O conteúdo do arquivo HomeController.vb é reproduzido na listagem 2.
