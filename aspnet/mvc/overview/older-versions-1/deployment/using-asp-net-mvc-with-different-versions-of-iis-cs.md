...
---
<a name="using-aspnet-mvc-with-different-versions-of-iis-c"></a>Usando o ASP.NET MVC com diferentes versões do IIS (c#)
====================
...
**Figura 2**: receber um erro 404 não encontrado ([clique para exibir a imagem em tamanho normal](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image4.png))
