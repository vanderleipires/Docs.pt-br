...
**Figura 03**: O adicionar controlador Menu ([clique para exibir a imagem em tamanho normal](displaying-a-table-of-database-data-cs/_static/image6.png))
...
**Figura 04**: caixa de diálogo o adicionar controlador ([clique para exibir a imagem em tamanho normal](displaying-a-table-of-database-data-cs/_static/image8.png))
...
**Figura 06**: caixa de diálogo Adicionar exibição do ([clique para exibir a imagem em tamanho normal](displaying-a-table-of-database-data-cs/_static/image12.png))
...
A exibição na listagem 4 contém um loop foreach que itera em todos os filmes. Para cada filme, o MovieTemplate parcial é usado para formatar o filme. O MovieTemplate é renderizado chamando o método auxiliar RenderPartial().
