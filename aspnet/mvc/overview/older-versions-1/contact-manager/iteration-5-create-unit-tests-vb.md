...
4. Adicione uma referência ao assembly Moq ao seu projeto de teste, selecionando a opção de menu **projeto, adicionar referência** para abrir o **adicionar referência** caixa de diálogo. Na guia Procurar, navegue até a pasta onde você descompactou Moq e selecione o assembly Moq.dll. Clique o **Okey** botão (consulte a Figura 2).


[![O desbloqueio Moq](iteration-5-create-unit-tests-vb/_static/image1.jpg)](iteration-5-create-unit-tests-vb/_static/image1.png)
...
[![Referências depois de adicionar Moq](iteration-5-create-unit-tests-vb/_static/image2.jpg)](iteration-5-create-unit-tests-vb/_static/image3.png)

**Figura 02**: referências depois da adição de Moq ([clique para exibir a imagem em tamanho normal](iteration-5-create-unit-tests-vb/_static/image4.png))
...
Crie uma nova pasta chamada modelos no projeto ContactManager.Tests. Em seguida, clique na pasta de modelos e selecione **adicionar, novo teste**. O **adicionar novo teste** caixa de diálogo mostrada na Figura 3 é exibida. Selecione o **de teste de unidade** modelo e nomeie o novo teste ContactManagerServiceTest.vb. Clique o **Okey** botão para adicionar o novo teste ao seu projeto de teste.
...
**Listando 1 - Models\ContactManagerServiceTest.vb**
...
Aplicativo ASP.NET MVC controlar o fluxo de interação do usuário. Quando um controlador de teste, você deseja testar se o controlador retorna os dados de resultado e o modo de exibição de ação à direita. Também convém testar se um controlador interage com classes de modelo da maneira esperada.
...
**A listagem 2 - Controllers\ContactControllerTest.vb**
