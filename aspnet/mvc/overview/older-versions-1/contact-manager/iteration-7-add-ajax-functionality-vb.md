...
[![Atualizar apenas os contatos](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**Figura 01**: atualizar apenas os contatos ([clique para exibir a imagem em tamanho normal](iteration-7-add-ajax-functionality-vb/_static/image2.png))
...
**A listagem 3 - Controllers\ContactController.vb (método de índice)**
...
**Listando 7 - Controllers\ContactController.vb (AjaxDelete)**   
