...
As instruções nesta seção não são atuais. Ver [provedor de email SendGrid configurar](/aspnet/core/security/authentication/accconfirm#configure-email-provider) para instruções de atualização.
