...
<span data-ttu-id="9cead-251">No **modo de exibição** menu, clique em **Gerenciador de servidores**.</span><span class="sxs-lookup"><span data-stu-id="9cead-251">In the **View** menu, click **Server Explorer**.</span></span>
