...
<span data-ttu-id="290ba-133">A classe ShoppingCart expõe os métodos a seguir:</span><span class="sxs-lookup"><span data-stu-id="290ba-133">The ShoppingCart class exposes the following methods:</span></span>
