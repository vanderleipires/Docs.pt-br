...
3. No **novo projeto ASP.NET MVC 4** select da caixa de diálogo de **aplicativo de Internet** modelo e certifique-se de que **Razor** é selecionado **domecanismodeexibição**. Clique em **Okey** para criar o projeto.
