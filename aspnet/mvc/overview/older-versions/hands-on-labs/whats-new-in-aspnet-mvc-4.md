...
4. <span data-ttu-id="e315c-166">Pressione **F5** para executar a solução e ver os modelos renovados.</span><span class="sxs-lookup"><span data-stu-id="e315c-166">Press **F5** to run the solution and see the renewed templates.</span></span> <span data-ttu-id="e315c-167">Você pode conferir os recursos a seguir:</span><span class="sxs-lookup"><span data-stu-id="e315c-167">You can check out the following features:</span></span>
    ...
    <span data-ttu-id="e315c-168">**Modelos de estilo moderno**</span><span class="sxs-lookup"><span data-stu-id="e315c-168">**Modern-style templates**</span></span>
...
3. <span data-ttu-id="e315c-279">Abra **Site.css** arquivo no Visual Studio Gerenciador de soluções, localizado em **conteúdo** pasta do projeto.</span><span class="sxs-lookup"><span data-stu-id="e315c-279">Open **Site.css** file from the Visual Studio Solution explorer, located in **Content** project folder.</span></span> <span data-ttu-id="e315c-280">Pressione **CTRL + F** para abrir a pesquisa integrada do Visual Studio e gravar  **@media**  para localizar o **consulta de mídia do CSS**.</span><span class="sxs-lookup"><span data-stu-id="e315c-280">Press **CTRL + F** to open Visual Studio integrated search, and write **@media** to locate the **CSS media query**.</span></span>
    ...
    <span data-ttu-id="e315c-283">*Localizando a consulta de mídia*</span><span class="sxs-lookup"><span data-stu-id="e315c-283">*Locating the media query*</span></span>
...
7. <span data-ttu-id="e315c-320">Pressione **F5** para executar a solução e, em seguida, navegue até a URL a seguir para testar o serviço de foto fictícias: `http://localhost:[port]/photo/gallery` (o valor [port] depende da porta atual em que o aplicativo foi iniciado).</span><span class="sxs-lookup"><span data-stu-id="e315c-320">Press **F5** to run the solution, and then browse to the following URL in order to test the mocked photo service: `http://localhost:[port]/photo/gallery` (the [port] value depends on the current port where the application was launched).</span></span> <span data-ttu-id="e315c-321">A solicitação para essa URL deve recuperar o conteúdo a **Photos.json** arquivo.</span><span class="sxs-lookup"><span data-stu-id="e315c-321">The request to this URL should retrieve the content of the **Photos.json** file.</span></span>
    ...
    <span data-ttu-id="e315c-323">*Testando o serviço de foto fictícios*</span><span class="sxs-lookup"><span data-stu-id="e315c-323">*Testing the mocked photo service*</span></span>
...
5. <span data-ttu-id="e315c-337">Adicione o seguinte usando instruções.</span><span class="sxs-lookup"><span data-stu-id="e315c-337">Add the following using statements.</span></span>
    ...
    <span data-ttu-id="e315c-338">(Código de trecho - *usos do ASP.NET MVC 4 laboratório - Ex02 - HomeController*)</span><span class="sxs-lookup"><span data-stu-id="e315c-338">(Code Snippet - *ASP.NET MVC 4 Lab - Ex02 - HomeController Usings*)</span></span>
...
10. <span data-ttu-id="e315c-349">Execute o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="e315c-349">Run the application.</span></span> <span data-ttu-id="e315c-350">Agora você deve ver a home page exibe as fotos na Galeria.</span><span class="sxs-lookup"><span data-stu-id="e315c-350">You should now see the home page displaying the photos in the gallery.</span></span>
    ...
    <span data-ttu-id="e315c-351">![Galeria de fotos](whats-new-in-aspnet-mvc-4/_static/image21.png "Galeria de fotos")</span><span class="sxs-lookup"><span data-stu-id="e315c-351">![Photo Gallery](whats-new-in-aspnet-mvc-4/_static/image21.png "Photo Gallery")</span></span>
...
6. <span data-ttu-id="e315c-417">Corrija o posicionamento do título da foto para mostrá-la no lado direito da imagem.</span><span class="sxs-lookup"><span data-stu-id="e315c-417">Fix the positioning of the photo title to make it show at the right side of the image.</span></span> <span data-ttu-id="e315c-418">Para fazer isso, adicione o seguinte código para o **Site.Mobile.css** arquivo.</span><span class="sxs-lookup"><span data-stu-id="e315c-418">To do this, add the following code to the **Site.Mobile.css** file.</span></span>

    <span data-ttu-id="e315c-419">CSS</span><span class="sxs-lookup"><span data-stu-id="e315c-419">CSS</span></span>

    [!code-css[Main](whats-new-in-aspnet-mvc-4/samples/sample12.css)]
7. <span data-ttu-id="e315c-420">Pressione **CTRL + S** para salvar as alterações.</span><span class="sxs-lookup"><span data-stu-id="e315c-420">Press **CTRL + S** to save the changes.</span></span>
8. <span data-ttu-id="e315c-421">Volte para o **emulador do Windows Phone** e atualizar o site.</span><span class="sxs-lookup"><span data-stu-id="e315c-421">Switch back to the **Windows Phone Emulator** and refresh the site.</span></span> <span data-ttu-id="e315c-422">Observe que o título de foto corretamente é posicionado agora.</span><span class="sxs-lookup"><span data-stu-id="e315c-422">Notice the photo title is properly positioned now.</span></span>

    <span data-ttu-id="e315c-423">![Título posicionado no lado direito da imagem](whats-new-in-aspnet-mvc-4/_static/image26.png "título posicionado no lado direito da imagem")</span><span class="sxs-lookup"><span data-stu-id="e315c-423">![Title positioned on the right side of the image](whats-new-in-aspnet-mvc-4/_static/image26.png "Title positioned on the right side of the image")</span></span>

    <span data-ttu-id="e315c-424">*Título posicionado no lado direito da imagem*</span><span class="sxs-lookup"><span data-stu-id="e315c-424">*Title positioned on the right side of the image*</span></span>

<a id="Task_3_-_jQuery_Mobile_Themes"></a>
#### <a name="task-3---jquery-mobile-themes"></a><span data-ttu-id="e315c-425">Tarefa 3 - jQuery Mobile temas</span><span class="sxs-lookup"><span data-stu-id="e315c-425">Task 3 - jQuery Mobile Themes</span></span>

<span data-ttu-id="e315c-426">Cada layout e o widget em jQuery Mobile foi projetada para um novo orientada a objeto CSS do framework que seja possível aplicar um tema concluída design visual unificada para sites e aplicativos.</span><span class="sxs-lookup"><span data-stu-id="e315c-426">Every layout and widget in jQuery Mobile is designed around a new object-oriented CSS framework that makes it possible to apply a complete unified visual design theme to sites and applications.</span></span>

<span data-ttu-id="e315c-427">padrão do jQuery Mobile tema inclui 5 amostras que recebem letras (a, b, c, r, e) para referência rápida.</span><span class="sxs-lookup"><span data-stu-id="e315c-427">jQuery Mobile's default Theme includes 5 swatches that are given letters (a, b, c, d, e) for quick reference.</span></span>

<span data-ttu-id="e315c-428">Nesta tarefa, você atualizará o layout móvel para usar um tema diferente do padrão.</span><span class="sxs-lookup"><span data-stu-id="e315c-428">In this task, you will update the mobile layout to use a different theme than the default.</span></span>

1. <span data-ttu-id="e315c-429">Alterne para o Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="e315c-429">Switch back to Visual Studio.</span></span>
2. <span data-ttu-id="e315c-430">Abra o  **\_Layout.Mobile.cshtml** arquivo localizado em **exibições \ compartilhadas**.</span><span class="sxs-lookup"><span data-stu-id="e315c-430">Open the **\_Layout.Mobile.cshtml** file located in **Views\Shared**.</span></span>
3. <span data-ttu-id="e315c-431">Localizar o elemento div com a função de dados definida como &quot;página&quot; e atualize o **dados tema** para &quot; **e**&quot;.</span><span class="sxs-lookup"><span data-stu-id="e315c-431">Find the div element with the data-role set to &quot;page&quot; and update the **data-theme** to &quot;**e**&quot;.</span></span>


    [!code-html[Main](whats-new-in-aspnet-mvc-4/samples/sample13.html)]
4. <span data-ttu-id="e315c-432">Pressione **CTRL + S** para salvar as alterações.</span><span class="sxs-lookup"><span data-stu-id="e315c-432">Press **CTRL + S** to save the changes.</span></span>
5. <span data-ttu-id="e315c-433">Atualizar o site no **emulador do Windows Phone** e observe o novo esquema de cores.</span><span class="sxs-lookup"><span data-stu-id="e315c-433">Refresh the site in the **Windows Phone Emulator** and notice the new colors scheme.</span></span>

    <span data-ttu-id="e315c-434">![Layout para dispositivos móveis com um esquema de cores diferentes](whats-new-in-aspnet-mvc-4/_static/image27.png "layout com um esquema de cores diferentes para dispositivos móveis")</span><span class="sxs-lookup"><span data-stu-id="e315c-434">![Mobile layout with a different color scheme](whats-new-in-aspnet-mvc-4/_static/image27.png "Mobile layout with a different color scheme")</span></span>

    <span data-ttu-id="e315c-435">*Layout para dispositivos móveis com um esquema de cores diferentes*</span><span class="sxs-lookup"><span data-stu-id="e315c-435">*Mobile layout with a different color scheme*</span></span>

<a id="Task_4_-_Using_the_View-Switcher_Component_and_the_Browser_Overriding_Features"></a>
#### <a name="task-4---using-the-view-switcher-component-and-the-browser-overriding-features"></a><span data-ttu-id="e315c-436">Tarefa 4 - usando o componente de alternância de exibição e o navegador substituindo recursos</span><span class="sxs-lookup"><span data-stu-id="e315c-436">Task 4 - Using the View-Switcher Component and the Browser Overriding Features</span></span>

<span data-ttu-id="e315c-437">É uma convenção mobile otimizado páginas da web para adicionar um link cujo texto é algo como o modo de exibição da área de trabalho ou modo completo do site que permite aos usuários a alternar para uma versão de área de trabalho da página.</span><span class="sxs-lookup"><span data-stu-id="e315c-437">A convention for mobile-optimized web pages is to add a link whose text is something like Desktop view or Full site mode that lets users switch to a desktop version of the page.</span></span> <span data-ttu-id="e315c-438">O pacote jQuery.Mobile.MVC inclui um exemplo **alternância de exibição** componente para essa finalidade usada no  **\_Layout.Mobile.cshtml** exibição.</span><span class="sxs-lookup"><span data-stu-id="e315c-438">The jQuery.Mobile.MVC package includes a sample **view-switcher** component for this purpose used in the **\_Layout.Mobile.cshtml** view.</span></span>

<span data-ttu-id="e315c-439">![Link para alternar para modo de área de trabalho](whats-new-in-aspnet-mvc-4/_static/image28.png "Link para alternar para modo de área de trabalho")</span><span class="sxs-lookup"><span data-stu-id="e315c-439">![Link to switch to Desktop View](whats-new-in-aspnet-mvc-4/_static/image28.png "Link to switch to Desktop View")</span></span>

<span data-ttu-id="e315c-440">*Para alternar para modo de exibição da área de trabalho*</span><span class="sxs-lookup"><span data-stu-id="e315c-440">*Link to switch to Desktop View*</span></span>

<span data-ttu-id="e315c-441">A alternância de exibição usa um novo recurso chamado **navegador substituindo**.</span><span class="sxs-lookup"><span data-stu-id="e315c-441">The view switcher uses a new feature called **Browser Overriding**.</span></span> <span data-ttu-id="e315c-442">Esse recurso permite que seu aplicativo lide com solicitações como se estivessem vindo de um navegador diferente (agente do usuário) que eles realmente são provenientes.</span><span class="sxs-lookup"><span data-stu-id="e315c-442">This feature lets your application treat requests as if they were coming from a different browser (user agent) than the one they are actually coming from.</span></span>

<span data-ttu-id="e315c-443">Nesta tarefa, você irá explorar a implementação de exemplo de um alternador de exibição adicionado jQuery.Mobile.MVC e o novo navegador substituindo recursos no ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="e315c-443">In this task, you will explore the sample implementation of a view-switcher added by jQuery.Mobile.MVC and the new browser overriding features in ASP.NET MVC 4.</span></span>

1. <span data-ttu-id="e315c-444">Alterne para o Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="e315c-444">Switch back to Visual Studio.</span></span>
2. <span data-ttu-id="e315c-445">Abra o  **\_Layout.Mobile.cshtml** exibição localizado sob o **exibições \ compartilhadas** pasta e observe o componente de alternância de exibição que está sendo referenciado como uma exibição parcial.</span><span class="sxs-lookup"><span data-stu-id="e315c-445">Open the **\_Layout.Mobile.cshtml** view located under the **Views\Shared** folder and notice the view-switcher component being referenced as a partial view.</span></span>

    <span data-ttu-id="e315c-446">![Layout para dispositivos móveis usando o componente de alternância de exibição](whats-new-in-aspnet-mvc-4/_static/image29.png "layout para dispositivos móveis usando o componente de alternância de exibição")</span><span class="sxs-lookup"><span data-stu-id="e315c-446">![Mobile layout using View-Switcher component](whats-new-in-aspnet-mvc-4/_static/image29.png "Mobile layout using View-Switcher component")</span></span>

    <span data-ttu-id="e315c-447">*Layout para dispositivos móveis usando o componente de alternância de exibição*</span><span class="sxs-lookup"><span data-stu-id="e315c-447">*Mobile layout using View-Switcher component*</span></span>
3. <span data-ttu-id="e315c-448">Abra o  **\_ViewSwitcher.cshtml** exibição parcial.</span><span class="sxs-lookup"><span data-stu-id="e315c-448">Open the **\_ViewSwitcher.cshtml** partial view.</span></span>

    <span data-ttu-id="e315c-449">A exibição parcial usa o novo método **ViewContext.HttpContext.GetOverriddenBrowser()** para determinar a origem da solicitação da web e mostrar o link correspondente para alternar entre os modos de exibição do Desktop ou Mobile.</span><span class="sxs-lookup"><span data-stu-id="e315c-449">The partial view uses the new method **ViewContext.HttpContext.GetOverriddenBrowser()** to determine the origin of the web request and show the corresponding link to switch either to the Desktop or Mobile views.</span></span>

    <span data-ttu-id="e315c-450">O **GetOverridenBrowser** método retorna um **HttpBrowserCapabilitiesBase** instância que corresponde ao agente do usuário definido atualmente para a solicitação (reais ou substituído).</span><span class="sxs-lookup"><span data-stu-id="e315c-450">The **GetOverridenBrowser** method returns an **HttpBrowserCapabilitiesBase** instance that corresponds to the user agent currently set for the request (actual or overridden).</span></span> <span data-ttu-id="e315c-451">Você pode usar esse valor para obter as propriedades como **IsMobileDevice**.</span><span class="sxs-lookup"><span data-stu-id="e315c-451">You can use this value to get properties such as **IsMobileDevice**.</span></span>

    <span data-ttu-id="e315c-452">![Exibição parcial ViewSwitcher](whats-new-in-aspnet-mvc-4/_static/image30.png "exibição parcial ViewSwitcher")</span><span class="sxs-lookup"><span data-stu-id="e315c-452">![ViewSwitcher partial view](whats-new-in-aspnet-mvc-4/_static/image30.png "ViewSwitcher partial view")</span></span>

    <span data-ttu-id="e315c-453">*Exibição parcial ViewSwitcher*</span><span class="sxs-lookup"><span data-stu-id="e315c-453">*ViewSwitcher partial view*</span></span>
4. <span data-ttu-id="e315c-454">Abra o **ViewSwitcherController.cs** classe localizado no **controladores** pasta.</span><span class="sxs-lookup"><span data-stu-id="e315c-454">Open the **ViewSwitcherController.cs** class located in the **Controllers** folder.</span></span> <span data-ttu-id="e315c-455">Check-out ação SwitchView é chamado por um link no componente ViewSwitcher e observe os novos métodos de HttpContext.</span><span class="sxs-lookup"><span data-stu-id="e315c-455">Check out that SwitchView action is called by the link in the ViewSwitcher component, and notice the new HttpContext methods.</span></span>

    - <span data-ttu-id="e315c-456">O **HttpContext.ClearOverridenBrowser()** método remove qualquer agente de usuário substituído para a solicitação atual.</span><span class="sxs-lookup"><span data-stu-id="e315c-456">The **HttpContext.ClearOverridenBrowser()** method removes any overridden user agent for the current request.</span></span>
    - <span data-ttu-id="e315c-457">O **HttpContext.SetOverridenBrowser()** método substitui o valor do agente de usuário real da solicitação usando o agente do usuário especificado.</span><span class="sxs-lookup"><span data-stu-id="e315c-457">The **HttpContext.SetOverridenBrowser()** method overrides the request's actual user agent value using the specified user agent.</span></span>  
        <span data-ttu-id="e315c-458">![Controlador ViewSwitcher](whats-new-in-aspnet-mvc-4/_static/image31.png "ViewSwitcher controlador")</span><span class="sxs-lookup"><span data-stu-id="e315c-458">![ViewSwitcher Controller](whats-new-in-aspnet-mvc-4/_static/image31.png "ViewSwitcher Controller")</span></span>  
<span data-ttu-id="e315c-459">*Controlador ViewSwitcher*</span><span class="sxs-lookup"><span data-stu-id="e315c-459">*ViewSwitcher Controller*</span></span>

        <span data-ttu-id="e315c-460">Substituição do navegador é dos principais recursos do ASP.NET MVC 4, que também está disponível mesmo se você não instalar o pacote jQuery.Mobile.MVC.</span><span class="sxs-lookup"><span data-stu-id="e315c-460">Browser Overriding is a core feature of ASP.NET MVC 4, which is also available even if you do not install the jQuery.Mobile.MVC package.</span></span> <span data-ttu-id="e315c-461">No entanto, esse recurso afeta somente exibição, layout e exibição parcial, e ele não afeta os recursos que dependem do objeto Request. browser.</span><span class="sxs-lookup"><span data-stu-id="e315c-461">However, this feature affects only view, layout, and partial-view, and it does not affect any of the features that depend on the Request.Browser object.</span></span>

<a id="Task_5_-_Adding_the_View-Switcher_in_the_Desktop_View"></a>
#### <a name="task-5---adding-the-view-switcher-in-the-desktop-view"></a><span data-ttu-id="e315c-462">Tarefa 5: adicionar a alternância de exibição na exibição da área de trabalho</span><span class="sxs-lookup"><span data-stu-id="e315c-462">Task 5 - Adding the View-Switcher in the Desktop View</span></span>

<span data-ttu-id="e315c-463">Nesta tarefa, você atualizará o layout da área de trabalho para incluir a alternância de exibição.</span><span class="sxs-lookup"><span data-stu-id="e315c-463">In this task, you will update the desktop layout to include the view-switcher.</span></span> <span data-ttu-id="e315c-464">Isso permitirá que os usuários móveis voltar para o modo de exibição móvel ao procurar o modo de exibição da área de trabalho.</span><span class="sxs-lookup"><span data-stu-id="e315c-464">This will allow mobile users to go back to the mobile view when browsing the desktop view.</span></span>

1. <span data-ttu-id="e315c-465">Atualizar o site no **emulador do Windows Phone**.</span><span class="sxs-lookup"><span data-stu-id="e315c-465">Refresh the site in the **Windows Phone Emulator**.</span></span>
2. <span data-ttu-id="e315c-466">Clique no **exibição da área de trabalho** link na parte superior da Galeria.</span><span class="sxs-lookup"><span data-stu-id="e315c-466">Click on the **Desktop view** link at the top of the gallery.</span></span> <span data-ttu-id="e315c-467">Observe que não há nenhuma alternância de exibição na exibição da área de trabalho para permitir que você retornar à exibição móvel.</span><span class="sxs-lookup"><span data-stu-id="e315c-467">Notice there is no view-switcher in the desktop view to allow you return to the mobile view.</span></span>
3. <span data-ttu-id="e315c-468">Volte para o Visual Studio e abra o  **\_cshtml** exibição.</span><span class="sxs-lookup"><span data-stu-id="e315c-468">Go back to Visual Studio and open the **\_Layout.cshtml** view.</span></span>
4. <span data-ttu-id="e315c-469">Localize a seção de login e inserir uma chamada para renderizar o  **\_ViewSwitcher** exibição parcial abaixo o  **\_LogOnPartial** exibição parcial.</span><span class="sxs-lookup"><span data-stu-id="e315c-469">Find the login section and insert a call to render the **\_ViewSwitcher** partial view below the **\_LogOnPartial** partial view.</span></span> <span data-ttu-id="e315c-470">Em seguida, pressione **CTRL + S** para salvar as alterações.</span><span class="sxs-lookup"><span data-stu-id="e315c-470">Then, press **CTRL + S** to save the changes.</span></span>


    [!code-cshtml[Main](whats-new-in-aspnet-mvc-4/samples/sample14.cshtml)]
5. <span data-ttu-id="e315c-471">Pressione **CTRL + S** para salvar as alterações.</span><span class="sxs-lookup"><span data-stu-id="e315c-471">Press **CTRL + S** to save the changes.</span></span>
6. <span data-ttu-id="e315c-472">Atualize a página no emulador do Windows Phone e clique duas vezes na tela para aumentar o zoom.</span><span class="sxs-lookup"><span data-stu-id="e315c-472">Refresh the page in the Windows Phone Emulator and double-click the screen to zoom in.</span></span> <span data-ttu-id="e315c-473">Observe que a página inicial agora mostra o **exibição móvel** link que alterna de móveis para o modo de área de trabalho.</span><span class="sxs-lookup"><span data-stu-id="e315c-473">Notice that the home page now shows the **Mobile view** link that switches from mobile to desktop view.</span></span>

    <span data-ttu-id="e315c-474">![Exibir alternador renderizado no modo de exibição da área de trabalho](whats-new-in-aspnet-mvc-4/_static/image32.png "alternância de exibição renderizado no modo de exibição da área de trabalho")</span><span class="sxs-lookup"><span data-stu-id="e315c-474">![View Switcher rendered in desktop view](whats-new-in-aspnet-mvc-4/_static/image32.png "View Switcher rendered in desktop view")</span></span>

    <span data-ttu-id="e315c-475">*Alternância de exibição renderizada no modo de exibição da área de trabalho*</span><span class="sxs-lookup"><span data-stu-id="e315c-475">*View Switcher rendered in desktop view*</span></span>
7. <span data-ttu-id="e315c-476">Alterne para o modo de exibição móvel novamente e navegue até **sobre** página (http://localhost [porta] / Home/sobre).</span><span class="sxs-lookup"><span data-stu-id="e315c-476">Switch to the Mobile view again and browse to **About** page (http://localhost[port]/Home/About).</span></span> <span data-ttu-id="e315c-477">Observe que, mesmo se você não criou uma exibição About.Mobile.cshtml, a página sobre é exibida usando o layout para dispositivos móveis (\_Layout.Mobile.cshtml).</span><span class="sxs-lookup"><span data-stu-id="e315c-477">Notice that, even if you haven't created an About.Mobile.cshtml view, the About page is displayed using the mobile layout (\_Layout.Mobile.cshtml).</span></span>

    <span data-ttu-id="e315c-478">![Sobre a página](whats-new-in-aspnet-mvc-4/_static/image33.png "sobre a página")</span><span class="sxs-lookup"><span data-stu-id="e315c-478">![About page](whats-new-in-aspnet-mvc-4/_static/image33.png "About page")</span></span>

    <span data-ttu-id="e315c-479">*Sobre a página*</span><span class="sxs-lookup"><span data-stu-id="e315c-479">*About page*</span></span>
8. <span data-ttu-id="e315c-480">Por fim, abra o site em um navegador da Web da área de trabalho.</span><span class="sxs-lookup"><span data-stu-id="e315c-480">Finally, open the site in a desktop Web browser.</span></span> <span data-ttu-id="e315c-481">Observe que nenhuma das atualizações do anteriores afetou a exibição da área de trabalho.</span><span class="sxs-lookup"><span data-stu-id="e315c-481">Notice that none of the previous updates has affected the desktop view.</span></span>

    <span data-ttu-id="e315c-482">![Exibição de área de trabalho Galeriadefotos](whats-new-in-aspnet-mvc-4/_static/image34.png "Galeriadefotos exibição de área de trabalho")</span><span class="sxs-lookup"><span data-stu-id="e315c-482">![PhotoGallery desktop view](whats-new-in-aspnet-mvc-4/_static/image34.png "PhotoGallery desktop view")</span></span>

    <span data-ttu-id="e315c-483">*Exibição de área de trabalho Galeriadefotos*</span><span class="sxs-lookup"><span data-stu-id="e315c-483">*PhotoGallery desktop view*</span></span>

<a id="Task_6_-_Creating_New_Display_Modes"></a>
#### <a name="task-6---creating-new-display-modes"></a><span data-ttu-id="e315c-484">Tarefa 6: criar novos modos de exibição</span><span class="sxs-lookup"><span data-stu-id="e315c-484">Task 6 - Creating New Display Modes</span></span>

<span data-ttu-id="e315c-485">O novo recurso de modos de exibição permite que um aplicativo selecione exibições dependendo do navegador que está gerando a solicitação.</span><span class="sxs-lookup"><span data-stu-id="e315c-485">The new display modes feature lets an application select views depending on the browser that is generating the request.</span></span> <span data-ttu-id="e315c-486">Por exemplo, se um navegador desktop solicitar a página inicial, o aplicativo retornará o **Views\Home\Index.cshtml** modelo.</span><span class="sxs-lookup"><span data-stu-id="e315c-486">For example, if a desktop browser requests the Home page, the application will return the **Views\Home\Index.cshtml** template.</span></span> <span data-ttu-id="e315c-487">Em seguida, se um navegador móvel solicitar a página inicial, o aplicativo retornará o **Views\Home\Index.mobile.cshtml** modelo.</span><span class="sxs-lookup"><span data-stu-id="e315c-487">Then, if a mobile browser requests the Home page, the application will return the **Views\Home\Index.mobile.cshtml** template.</span></span>

<span data-ttu-id="e315c-488">Nesta tarefa, você criará um layout personalizado para os dispositivos iPhone e você precisará simular solicitações de dispositivos iPhone.</span><span class="sxs-lookup"><span data-stu-id="e315c-488">In this task, you will create a customized layout for iPhone devices, and you will have to simulate requests from iPhone devices.</span></span> <span data-ttu-id="e315c-489">Para fazer isso, você pode usar qualquer um emulador/simulador de iPhone (como [Electric simulador de móveis](http://www.electricplum.com/)) ou um navegador com os complementos que modificam o agente do usuário.</span><span class="sxs-lookup"><span data-stu-id="e315c-489">To do this, you can use either an iPhone emulator/simulator (like [Electric Mobile Simulator](http://www.electricplum.com/)) or a browser with add-ons that modify the user agent.</span></span> <span data-ttu-id="e315c-490">Para obter instruções sobre como definir a cadeia de caracteres de agente do usuário em um navegador Safari emular um iPhone, consulte [como permitir que o Safari fingem é IE](http://www.davidalison.com/2008/05/how-to-let-safari-pretend-its-ie.html) no blog de David Alison.</span><span class="sxs-lookup"><span data-stu-id="e315c-490">For instructions on how to set the user agent string in an Safari browser to emulate an iPhone, see [How to let Safari pretend it's IE](http://www.davidalison.com/2008/05/how-to-let-safari-pretend-its-ie.html) in David Alison's blog.</span></span>

<span data-ttu-id="e315c-491">**Observe que essa tarefa é opcional e você pode continuar em todo o laboratório sem executá-la.**</span><span class="sxs-lookup"><span data-stu-id="e315c-491">**Notice that this task is optional and you can continue throughout the lab without executing it.**</span></span>

1. <span data-ttu-id="e315c-492">No Visual Studio, pressione **SHIFT** + **F5** para parar a depuração do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="e315c-492">In Visual Studio, press **SHIFT** + **F5** to stop debugging the application.</span></span>
2. <span data-ttu-id="e315c-493">Abra **Global.asax.cs** e adicione o seguinte usando a instrução.</span><span class="sxs-lookup"><span data-stu-id="e315c-493">Open **Global.asax.cs** and add the following using statement.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample15.cs)]
3. <span data-ttu-id="e315c-494">Adicione o seguinte código realçado no aplicativo\_método Start.</span><span class="sxs-lookup"><span data-stu-id="e315c-494">Add the following highlighted code into the Application\_Start method.</span></span>

    <span data-ttu-id="e315c-495">(Código de trecho - *ASP.NET MVC 4 laboratório - Ex03 - iPhone DisplayMode*)</span><span class="sxs-lookup"><span data-stu-id="e315c-495">(Code Snippet - *ASP.NET MVC 4 Lab - Ex03 - iPhone DisplayMode*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample16.cs)]

    <span data-ttu-id="e315c-496">Você registrou um novo **DefaultDisplayMode chamado &quot;iPhone&quot;**, dentro de estático **DisplayModeProvider.Instance.Modes** lista estática, o que será comparada com cada solicitação de entrada.</span><span class="sxs-lookup"><span data-stu-id="e315c-496">You have registered a new **DefaultDisplayMode named &quot;iPhone&quot;**, within the static **DisplayModeProvider.Instance.Modes** static list, that will be matched against each incoming request.</span></span> <span data-ttu-id="e315c-497">Se a solicitação de entrada contiver a cadeia de caracteres &quot;iPhone&quot;, ASP.NET MVC encontrará os modos de exibição cujo nome contém o &quot;iPhone&quot; sufixo.</span><span class="sxs-lookup"><span data-stu-id="e315c-497">If the incoming request contains the string &quot;iPhone&quot;, ASP.NET MVC will find the views whose name contain the &quot;iPhone&quot; suffix.</span></span> <span data-ttu-id="e315c-498">O parâmetro 0 indica como específico é o novo modo; Por exemplo, essa exibição é mais específica que geral &quot;.mobile&quot; regra que corresponde a solicitações de dispositivos móveis.</span><span class="sxs-lookup"><span data-stu-id="e315c-498">The 0 parameter indicates how specific is the new mode; for instance, this view is more specific than the general &quot;.mobile&quot; rule that matches requests from mobile devices.</span></span>

    <span data-ttu-id="e315c-499">Depois que esse código é executado, quando um navegador de iPhone gera uma solicitação, o aplicativo usará o **exibições \ compartilhadas\\_Layout.iPhone.cshtml** layout, você criará as próximas etapas.</span><span class="sxs-lookup"><span data-stu-id="e315c-499">After this code runs, when an iPhone browser generates a request, your application will use the **Views\Shared\\_Layout.iPhone.cshtml** layout you will create in the next steps.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e315c-500">Essa maneira de testar a solicitação para iPhone foi simplificado para fins de demonstração e pode não funcionar conforme o esperado para cada cadeia de caracteres de agente de usuário do iPhone (para teste de exemplo diferencia maiusculas de minúsculas).</span><span class="sxs-lookup"><span data-stu-id="e315c-500">This way of testing the request for iPhone has been simplified for demo purposes and might not work as expected for every iPhone user agent string (for example test is case sensitive).</span></span>
4. <span data-ttu-id="e315c-501">Criar uma cópia do  **\_Layout.Mobile.cshtml** arquivo o **exibições \ compartilhadas** pasta e renomeie a cópia de &quot;  **\_Layout.iPhone.csthml** &quot;.</span><span class="sxs-lookup"><span data-stu-id="e315c-501">Create a copy of the **\_Layout.Mobile.cshtml** file in the **Views\Shared** folder and rename the copy to &quot;**\_Layout.iPhone.csthml**&quot;.</span></span>
5. <span data-ttu-id="e315c-502">Abra  **\_Layout.iPhone.csthml** criado na etapa anterior.</span><span class="sxs-lookup"><span data-stu-id="e315c-502">Open **\_Layout.iPhone.csthml** you created in the previous step.</span></span>
6. <span data-ttu-id="e315c-503">Localizar o elemento div com o atributo de dados de função definido como **página** e altere o **dados tema** atributo &quot; **um**&quot;.</span><span class="sxs-lookup"><span data-stu-id="e315c-503">Find the div element with the data-role attribute set to **page** and change the **data-theme** attribute to &quot;**a**&quot;.</span></span>


    [!code-cshtml[Main](whats-new-in-aspnet-mvc-4/samples/sample17.cshtml)]

    <span data-ttu-id="e315c-504">Agora você tem 3 layouts em seu aplicativo ASP.NET MVC 4:</span><span class="sxs-lookup"><span data-stu-id="e315c-504">Now you have 3 layouts in your ASP.NET MVC 4 application:</span></span>

    1. <span data-ttu-id="e315c-505">**\_Cshtml**: layout padrão usado para navegadores de desktop.</span><span class="sxs-lookup"><span data-stu-id="e315c-505">**\_Layout.cshtml**: default layout used for desktop browsers.</span></span>
    2. <span data-ttu-id="e315c-506">**\_Layout.Mobile.cshtml**: layout padrão usado para dispositivos móveis.</span><span class="sxs-lookup"><span data-stu-id="e315c-506">**\_Layout.mobile.cshtml**: default layout used for mobile devices.</span></span>
    3. <span data-ttu-id="e315c-507">**\_Layout.iPhone.cshtml**: layout específicas para os dispositivos iPhone, usando um esquema de cores diferente para diferenciar de \_Layout.mobile.cshtml.</span><span class="sxs-lookup"><span data-stu-id="e315c-507">**\_Layout.iPhone.cshtml**: specific layout for iPhone devices, using a different color scheme to differentiate from \_Layout.mobile.cshtml.</span></span>
7. <span data-ttu-id="e315c-508">Pressione **F5** para executar o aplicativo e navegue até o site no **emulador do Windows Phone**.</span><span class="sxs-lookup"><span data-stu-id="e315c-508">Press **F5** to run the application and browse the site in the **Windows Phone Emulator**.</span></span>
8. <span data-ttu-id="e315c-509">Abra um **simulador de iPhone** (consulte [Apêndice C](#AppendixC) para obter instruções sobre como instalar e configurar um simulador de iPhone) e navegue até o site muito.</span><span class="sxs-lookup"><span data-stu-id="e315c-509">Open an **iPhone simulator** (see [Appendix C](#AppendixC) for instructions on how to install and configure an iPhone simulator), and browse to the site too.</span></span> <span data-ttu-id="e315c-510">Observe que cada telefone está usando o modelo específico.</span><span class="sxs-lookup"><span data-stu-id="e315c-510">Notice that each phone is using the specific template.</span></span>

    ![Using-different-views-for-each-mobile-device2](whats-new-in-aspnet-mvc-4/_static/image35.png)

    <span data-ttu-id="e315c-512">*Usando modos de exibição diferentes para cada dispositivo móvel*</span><span class="sxs-lookup"><span data-stu-id="e315c-512">*Using different views for each mobile device*</span></span>

<a id="Exercise4"></a>

<a id="Exercise_4_Using_Asynchronous_Controllers"></a>
### <a name="exercise-4-using-asynchronous-controllers"></a><span data-ttu-id="e315c-513">Exercício 4: Usando controladores assíncronos</span><span class="sxs-lookup"><span data-stu-id="e315c-513">Exercise 4: Using Asynchronous Controllers</span></span>

<span data-ttu-id="e315c-514">Microsoft .NET Framework 4.5 apresenta novos recursos de idioma em c# e Visual Basic para fornecer uma nova base de assincronia na programação .NET.</span><span class="sxs-lookup"><span data-stu-id="e315c-514">Microsoft .NET Framework 4.5 introduces new language features in C# and Visual Basic to provide a new foundation for asynchrony in .NET programming.</span></span> <span data-ttu-id="e315c-515">Essa nova base torna programação assíncrona semelhantes e sobre tão simples quanto - programação síncrona.</span><span class="sxs-lookup"><span data-stu-id="e315c-515">This new foundation makes asynchronous programming similar to - and about as straightforward as - synchronous programming.</span></span> <span data-ttu-id="e315c-516">Agora é possível gravar os métodos de ação assíncrono no ASP.NET MVC 4 usando o **AsyncController** classe.</span><span class="sxs-lookup"><span data-stu-id="e315c-516">You are now able to write asynchronous action methods in ASP.NET MVC 4 by using the **AsyncController** class.</span></span> <span data-ttu-id="e315c-517">Você pode usar métodos de ação assíncrono de longa duração, CPU não associado a solicitações.</span><span class="sxs-lookup"><span data-stu-id="e315c-517">You can use asynchronous action methods for long-running, non-CPU bound requests.</span></span> <span data-ttu-id="e315c-518">Isso evita que o servidor Web da execução de trabalho enquanto a solicitação está sendo processada de bloqueio.</span><span class="sxs-lookup"><span data-stu-id="e315c-518">This avoids blocking the Web server from performing work while the request is being processed.</span></span> <span data-ttu-id="e315c-519">A classe AsyncController normalmente é usada para chamadas de serviço Web de longa execução.</span><span class="sxs-lookup"><span data-stu-id="e315c-519">The AsyncController class is typically used for long-running Web service calls.</span></span>

<span data-ttu-id="e315c-520">Este exercício explica os conceitos básicos de uma operação assíncrona no ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="e315c-520">This exercise explains the basics of asynchronous operation in ASP.NET MVC 4.</span></span> <span data-ttu-id="e315c-521">Se você quiser se aprofundar mais, confira o seguinte artigo: [ [https://msdn.microsoft.com/library/ee728598%28v=vs.100%29.aspx](https://msdn.microsoft.com/library/ee728598%28v=vs.100%29.aspx)](https://msdn.microsoft.com/library/ee728598%28v=vs.100%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="e315c-521">If you want a deeper dive, you can check out the following article: [[https://msdn.microsoft.com/library/ee728598%28v=vs.100%29.aspx](https://msdn.microsoft.com/library/ee728598%28v=vs.100%29.aspx)](https://msdn.microsoft.com/library/ee728598%28v=vs.100%29.aspx)</span></span>

<a id="Task_1_-_Implementing_an_Asynchronous_Controller"></a>
#### <a name="task-1---implementing-an-asynchronous-controller"></a><span data-ttu-id="e315c-522">Tarefa 1: Implementando um controlador assíncrono</span><span class="sxs-lookup"><span data-stu-id="e315c-522">Task 1 - Implementing an Asynchronous Controller</span></span>

1. <span data-ttu-id="e315c-523">Abra o **começar** solução localizado em **fonte/Ex4-Async/Begin/** pasta.</span><span class="sxs-lookup"><span data-stu-id="e315c-523">Open the **Begin** solution located at **Source/Ex4-Async/Begin/** folder.</span></span> <span data-ttu-id="e315c-524">Caso contrário, você pode continuar usando o **final** solução obtido executando o exercício anterior.</span><span class="sxs-lookup"><span data-stu-id="e315c-524">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

    1. <span data-ttu-id="e315c-525">Se você abriu fornecido **começar** solução, você precisará baixar alguns pacotes do NuGet ausentes antes de continuar.</span><span class="sxs-lookup"><span data-stu-id="e315c-525">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="e315c-526">Para fazer isso, clique o **projeto** menu e selecione **gerenciar pacotes NuGet**.</span><span class="sxs-lookup"><span data-stu-id="e315c-526">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
    2. <span data-ttu-id="e315c-527">No **gerenciar pacotes NuGet** caixa de diálogo, clique em **restaurar** para baixar os pacotes ausentes.</span><span class="sxs-lookup"><span data-stu-id="e315c-527">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
    3. <span data-ttu-id="e315c-528">Por fim, compile a solução clicando **criar** | **compilar solução**.</span><span class="sxs-lookup"><span data-stu-id="e315c-528">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e315c-529">Uma das vantagens de usar NuGet é que você não precisa enviar todas as bibliotecas no seu projeto, reduzindo o tamanho do projeto.</span><span class="sxs-lookup"><span data-stu-id="e315c-529">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="e315c-530">Com o NuGet Power Tools, especificando as versões do pacote no arquivo Packages. config, você poderá baixar todas as bibliotecas necessárias na primeira vez que você executar o projeto.</span><span class="sxs-lookup"><span data-stu-id="e315c-530">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="e315c-531">É por isso você terá que executar estas etapas depois de abrir uma solução existente neste laboratório.</span><span class="sxs-lookup"><span data-stu-id="e315c-531">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="e315c-532">Abra o **HomeController** classe o **controladores** pasta.</span><span class="sxs-lookup"><span data-stu-id="e315c-532">Open the **HomeController.cs** class from the **Controllers** folder.</span></span>
3. <span data-ttu-id="e315c-533">Adicione o seguinte usando a instrução.</span><span class="sxs-lookup"><span data-stu-id="e315c-533">Add the following using statement.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample18.cs)]
4. <span data-ttu-id="e315c-534">Atualização de **HomeController** classe para herdar de **AsyncController**.</span><span class="sxs-lookup"><span data-stu-id="e315c-534">Update the **HomeController** class to inherit from **AsyncController**.</span></span> <span data-ttu-id="e315c-535">Controladores que derivam de AsyncController habilitar o ASP.NET processar solicitações assíncronas e ainda pode métodos de ação síncrono do serviço.</span><span class="sxs-lookup"><span data-stu-id="e315c-535">Controllers that derive from AsyncController enable ASP.NET to process asynchronous requests, and they can still service synchronous action methods.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample19.cs)]
5. <span data-ttu-id="e315c-536">Adicionar o **async** palavra-chave para o **índice** método e o tipo de retorno **tarefa&lt;ActionResult&gt;**.</span><span class="sxs-lookup"><span data-stu-id="e315c-536">Add the **async** keyword to the **Index** method and make it return the type **Task&lt;ActionResult&gt;**.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample20.cs)]

    > [!NOTE]
    > <span data-ttu-id="e315c-537">O **async** palavra-chave é uma das novas palavras-chave do .NET Framework 4.5 fornece; ele informa ao compilador que este método contém código assíncrono.</span><span class="sxs-lookup"><span data-stu-id="e315c-537">The **async** keyword is one of the new keywords the .NET Framework 4.5 provides; it tells the compiler that this method contains asynchronous code.</span></span> <span data-ttu-id="e315c-538">Um **tarefa** objeto representa uma operação assíncrona que pode ser concluída em algum momento no futuro.</span><span class="sxs-lookup"><span data-stu-id="e315c-538">A **Task** object represents an asynchronous operation that may complete at some point in the future.</span></span>
6. <span data-ttu-id="e315c-539">Substitua o **cliente. GetAsync()** chamada com a versão assíncrona completa usando palavra-chave await conforme mostrado abaixo.</span><span class="sxs-lookup"><span data-stu-id="e315c-539">Replace the **client.GetAsync()** call with the full async version using await keyword as shown below.</span></span>

    <span data-ttu-id="e315c-540">(Código de trecho - *GetAsync do ASP.NET MVC 4 laboratório - Ex04 -*)</span><span class="sxs-lookup"><span data-stu-id="e315c-540">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - GetAsync*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample21.cs)]

    > [!NOTE]
    > <span data-ttu-id="e315c-541">Na versão anterior, você estava usando o **resultados** propriedade o **tarefa** objeto para bloquear o thread até que o resultado é retornado (versão de sincronização).</span><span class="sxs-lookup"><span data-stu-id="e315c-541">In the previous version, you were using the **Result** property from the **Task** object to block the thread until the result is returned (sync version).</span></span>
    > 
    > <span data-ttu-id="e315c-542">Adicionando o **await** palavra-chave informa ao compilador de forma assíncrona espera para a tarefa retornada da chamada de método.</span><span class="sxs-lookup"><span data-stu-id="e315c-542">Adding the **await** keyword tells the compiler to asynchronously wait for the task returned from the method call.</span></span> <span data-ttu-id="e315c-543">Isso significa que o restante do código será executado como um retorno de chamada somente depois que o método espera é concluída.</span><span class="sxs-lookup"><span data-stu-id="e315c-543">This means that the rest of the code will be executed as a callback only after the awaited method completes.</span></span> <span data-ttu-id="e315c-544">Outra coisa a observar é que você não precisa alterar seu bloco try-catch para que funcione: as exceções que ocorrem em segundo plano ou em primeiro plano ainda serão capturadas sem qualquer trabalho extra usando um manipulador fornecido pelo framework.</span><span class="sxs-lookup"><span data-stu-id="e315c-544">Another thing to notice is that you do not need to change your try-catch block in order to make this work: the exceptions that happen in background or in foreground will still be caught without any extra work using a handler provided by the framework.</span></span>
7. <span data-ttu-id="e315c-545">Alterar o código para continuar com a implementação assíncrona, substituindo as linhas com o novo código, conforme mostrado abaixo</span><span class="sxs-lookup"><span data-stu-id="e315c-545">Change the code to continue with the asynchronous implementation by replacing the lines with the new code as shown below</span></span>

    <span data-ttu-id="e315c-546">(Código de trecho - *ReadAsStringAsync do ASP.NET MVC 4 laboratório - Ex04 -*)</span><span class="sxs-lookup"><span data-stu-id="e315c-546">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - ReadAsStringAsync*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample22.cs)]
8. <span data-ttu-id="e315c-547">Execute o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="e315c-547">Run the application.</span></span> <span data-ttu-id="e315c-548">Você não observará nenhuma alteração principal, mas seu código não impedirá que um thread do pool de threads, tornando um melhor uso dos recursos do servidor e melhorar o desempenho.</span><span class="sxs-lookup"><span data-stu-id="e315c-548">You will notice no major changes, but your code will not block a thread from the thread pool making a better usage of the server resources and improving performance.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e315c-549">Você pode aprender mais sobre os novos recursos de programação assíncronos no laboratório &quot; **programação assíncrona no .NET 4.5 com c# e Visual Basic** &quot; incluído no Kit de treinamento do Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="e315c-549">You can learn more about the new asynchronous programming features in the lab &quot;**Asynchronous Programming in .NET 4.5 with C# and Visual Basic**&quot; included in the Visual Studio Training Kit.</span></span>

<a id="Task_2_-_Handling_Time-Outs_with_Cancellation_Tokens"></a>
#### <a name="task-2---handling-time-outs-with-cancellation-tokens"></a><span data-ttu-id="e315c-550">Tarefa 2 - tempos limite de tratamento com Tokens de cancelamento</span><span class="sxs-lookup"><span data-stu-id="e315c-550">Task 2 - Handling Time-Outs with Cancellation Tokens</span></span>

<span data-ttu-id="e315c-551">Métodos de ação assíncrono que retornam instâncias de tarefa também podem dar suporte a tempos limite.</span><span class="sxs-lookup"><span data-stu-id="e315c-551">Asynchronous action methods that return Task instances can also support time-outs.</span></span> <span data-ttu-id="e315c-552">Nesta tarefa, você atualizará o código do método de índice para lidar com um cenário de tempo limite usando um token de cancelamento.</span><span class="sxs-lookup"><span data-stu-id="e315c-552">In this task, you will update the Index method code to handle a time-out scenario using a cancellation token.</span></span>

1. <span data-ttu-id="e315c-553">Volte para o Visual Studio e pressione **SHIFT + F5** para parar a depuração.</span><span class="sxs-lookup"><span data-stu-id="e315c-553">Go back to Visual Studio and press **SHIFT + F5** to stop debugging.</span></span>
2. <span data-ttu-id="e315c-554">Adicione o seguinte usando a instrução de **HomeController** arquivo.</span><span class="sxs-lookup"><span data-stu-id="e315c-554">Add the following using statement to the **HomeController.cs** file.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample23.cs)]
3. <span data-ttu-id="e315c-555">Atualizar a ação de índice para receber um **CancellationToken** argumento.</span><span class="sxs-lookup"><span data-stu-id="e315c-555">Update the Index action to receive a **CancellationToken** argument.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample24.cs)]
4. <span data-ttu-id="e315c-556">Atualização de **GetAsync** chamada para passar o token de cancelamento.</span><span class="sxs-lookup"><span data-stu-id="e315c-556">Update the **GetAsync** call to pass the cancellation token.</span></span>

    <span data-ttu-id="e315c-557">(Código de trecho - *ASP.NET MVC 4 laboratório - Ex04 - SendAsync com CancellationToken*)</span><span class="sxs-lookup"><span data-stu-id="e315c-557">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - SendAsync with CancellationToken*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample25.cs)]
5. <span data-ttu-id="e315c-558">Decore o *índice* método com um **AsyncTimeout** atributo definido como 500 milissegundos e um **HandleError** atributo configurado para tratar  **TaskCanceledException** redirecionando para um **TimedOut** exibição.</span><span class="sxs-lookup"><span data-stu-id="e315c-558">Decorate the *Index* method with an **AsyncTimeout** attribute set to 500 milliseconds and a **HandleError** attribute configured to handle **TaskCanceledException** by redirecting to a **TimedOut** view.</span></span>

    <span data-ttu-id="e315c-559">(Código de trecho - *atributos do ASP.NET MVC 4 laboratório - Ex04 -*)</span><span class="sxs-lookup"><span data-stu-id="e315c-559">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - Attributes*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample26.cs)]
6. <span data-ttu-id="e315c-560">Abra o **PhotoController** classe e atualizar o **galeria** método para atrasar os milissegundos de execução 1000 (1 segundo) para simular uma tarefa demorada.</span><span class="sxs-lookup"><span data-stu-id="e315c-560">Open the **PhotoController** class and update the **Gallery** method to delay the execution 1000 miliseconds (1 second) to simulate a long running task.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample27.cs)]
7. <span data-ttu-id="e315c-561">Abra o **Web. config** de arquivos e habilitar os erros personalizados, adicionando o seguinte elemento.</span><span class="sxs-lookup"><span data-stu-id="e315c-561">Open the **Web.config** file and enable custom errors by adding the following element.</span></span>


    [!code-xml[Main](whats-new-in-aspnet-mvc-4/samples/sample28.xml)]
8. <span data-ttu-id="e315c-562">Criar uma nova exibição em **exibições \ compartilhadas** chamado **TimedOut** e use o layout padrão.</span><span class="sxs-lookup"><span data-stu-id="e315c-562">Create a new view in **Views\Shared** named **TimedOut** and use the default layout.</span></span> <span data-ttu-id="e315c-563">No Gerenciador de soluções, clique com botão direito do **exibições \ compartilhadas** pasta e selecione **adicionar | Exibição**.</span><span class="sxs-lookup"><span data-stu-id="e315c-563">In the Solution Explorer, right-click the **Views\Shared** folder and select **Add | View**.</span></span>

    <span data-ttu-id="e315c-564">![Usando modos de exibição diferentes para cada dispositivo móvel](whats-new-in-aspnet-mvc-4/_static/image36.png "usando diferentes modos de exibição para cada dispositivo móvel")</span><span class="sxs-lookup"><span data-stu-id="e315c-564">![Using different views for each mobile device](whats-new-in-aspnet-mvc-4/_static/image36.png "Using different views for each mobile device")</span></span>

    <span data-ttu-id="e315c-565">*Usando modos de exibição diferentes para cada dispositivo móvel*</span><span class="sxs-lookup"><span data-stu-id="e315c-565">*Using different views for each mobile device*</span></span>
9. <span data-ttu-id="e315c-566">Atualização de **TimedOut** exibir conteúdo, conforme mostrado abaixo.</span><span class="sxs-lookup"><span data-stu-id="e315c-566">Update the **TimedOut** view content as shown below.</span></span>


    [!code-cshtml[Main](whats-new-in-aspnet-mvc-4/samples/sample29.cshtml)]
10. <span data-ttu-id="e315c-567">Execute o aplicativo e navegue até a URL raiz.</span><span class="sxs-lookup"><span data-stu-id="e315c-567">Run the application and navigate to the root URL.</span></span> <span data-ttu-id="e315c-568">Como você adicionou um **Sleep** de 1000 milissegundos, você obterá um erro de tempo limite, gerado pelo **AsyncTimeout** de atributos e catch pelo **HandleError** atributo.</span><span class="sxs-lookup"><span data-stu-id="e315c-568">As you have added a **Thread.Sleep** of 1000 milliseconds, you will get a time-out error, generated by the **AsyncTimeout** attribute and catch by the **HandleError** attribute.</span></span>

    <span data-ttu-id="e315c-569">![Exceção de tempo limite tratada](whats-new-in-aspnet-mvc-4/_static/image37.png "tratada de exceção de tempo limite")</span><span class="sxs-lookup"><span data-stu-id="e315c-569">![Time-out exception handled](whats-new-in-aspnet-mvc-4/_static/image37.png "Time-out exception handled")</span></span>

    <span data-ttu-id="e315c-570">*Exceção de tempo limite tratada*</span><span class="sxs-lookup"><span data-stu-id="e315c-570">*Time-out exception handled*</span></span>

> [!NOTE]
> <span data-ttu-id="e315c-571">Além disso, você pode implantar esse aplicativo para Windows Azure Web Sites a seguir [apêndice d: publicação um aplicativo ASP.NET MVC 4 usando a implantação da Web](#AppendixD).</span><span class="sxs-lookup"><span data-stu-id="e315c-571">Additionally, you can deploy this application to Windows Azure Web Sites following [Appendix D: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixD).</span></span>


<a id="Summary"></a>

<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="e315c-572">Resumo</span><span class="sxs-lookup"><span data-stu-id="e315c-572">Summary</span></span>

<span data-ttu-id="e315c-573">Neste prático laboratório, você tenha observado alguns dos novos recursos residente no ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="e315c-573">In this hands-on-lab, you've observed some of the new features resident in ASP.NET MVC 4.</span></span> <span data-ttu-id="e315c-574">Foram discutidos os seguintes conceitos:</span><span class="sxs-lookup"><span data-stu-id="e315c-574">The following concepts have been discussed:</span></span>

- <span data-ttu-id="e315c-575">Aproveitar os aprimoramentos para o ASP.NET MVC projeto modelos, incluindo o novo modelo de projeto de aplicativo móvel</span><span class="sxs-lookup"><span data-stu-id="e315c-575">Take advantage of the enhancements to the ASP.NET MVC project templates-including the new mobile application project template</span></span>
- <span data-ttu-id="e315c-576">Use o atributo de visor do HTML5 e consultas de mídia CSS para melhorar a exibição em dispositivos móveis</span><span class="sxs-lookup"><span data-stu-id="e315c-576">Use the HTML5 viewport attribute and CSS media queries to improve the display on mobile devices</span></span>
- <span data-ttu-id="e315c-577">Use o jQuery Mobile para aprimoramentos progressivos e para a criação de interface da web otimizada para toque</span><span class="sxs-lookup"><span data-stu-id="e315c-577">Use jQuery Mobile for progressive enhancements and for building touch-optimized web UI</span></span>
- <span data-ttu-id="e315c-578">Criar exibições específicas para dispositivos móveis</span><span class="sxs-lookup"><span data-stu-id="e315c-578">Create mobile-specific views</span></span>
- <span data-ttu-id="e315c-579">Use o componente de alternância de exibição para alternar entre modos de exibição móveis e área de trabalho do aplicativo</span><span class="sxs-lookup"><span data-stu-id="e315c-579">Use the view-switcher component to toggle between mobile and desktop views in the application</span></span>
- <span data-ttu-id="e315c-580">Criar controladores assíncronos usando o suporte da tarefa</span><span class="sxs-lookup"><span data-stu-id="e315c-580">Create asynchronous controllers using task support</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Using_Code_Snippets"></a>
## <a name="appendix-a-using-code-snippets"></a><span data-ttu-id="e315c-581">Apêndice a: usar trechos de código</span><span class="sxs-lookup"><span data-stu-id="e315c-581">Appendix A: Using Code Snippets</span></span>

<span data-ttu-id="e315c-582">Com trechos de código, você tem todo o código que é necessário ao seu alcance.</span><span class="sxs-lookup"><span data-stu-id="e315c-582">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="e315c-583">O documento de laboratório informará exatamente quando você pode usá-los, conforme mostrado na figura a seguir.</span><span class="sxs-lookup"><span data-stu-id="e315c-583">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="e315c-584">![Usando trechos de código do Visual Studio para inserir o código no seu projeto](whats-new-in-aspnet-mvc-4/_static/image38.png "trechos de código com o Visual Studio para inserir código em seu projeto")</span><span class="sxs-lookup"><span data-stu-id="e315c-584">![Using Visual Studio code snippets to insert code into your project](whats-new-in-aspnet-mvc-4/_static/image38.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="e315c-585">*Usando trechos de código do Visual Studio para inserir código em seu projeto*</span><span class="sxs-lookup"><span data-stu-id="e315c-585">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="e315c-586">***Para adicionar um trecho de código usando o teclado (apenas c#)***</span><span class="sxs-lookup"><span data-stu-id="e315c-586">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="e315c-587">Posicione o cursor onde você deseja inserir o código.</span><span class="sxs-lookup"><span data-stu-id="e315c-587">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="e315c-588">Comece a digitar o nome do trecho (sem espaços ou hifens).</span><span class="sxs-lookup"><span data-stu-id="e315c-588">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="e315c-589">Observe como IntelliSense exibe os nomes dos trechos de código correspondentes.</span><span class="sxs-lookup"><span data-stu-id="e315c-589">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="e315c-590">Selecione o trecho correto (ou continue digitando até que o nome do trecho de código inteiro é selecionado).</span><span class="sxs-lookup"><span data-stu-id="e315c-590">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="e315c-591">Pressione a tecla Tab duas vezes para inserir o trecho de código no local do cursor.</span><span class="sxs-lookup"><span data-stu-id="e315c-591">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="e315c-592">![Comece a digitar o nome do fragmento](whats-new-in-aspnet-mvc-4/_static/image39.png "comece a digitar o nome do trecho de código")</span><span class="sxs-lookup"><span data-stu-id="e315c-592">![Start typing the snippet name](whats-new-in-aspnet-mvc-4/_static/image39.png "Start typing the snippet name")</span></span>

<span data-ttu-id="e315c-593">*Comece a digitar o nome do trecho de código*</span><span class="sxs-lookup"><span data-stu-id="e315c-593">*Start typing the snippet name*</span></span>

<span data-ttu-id="e315c-594">![Pressione Tab para selecionar o trecho de código realçado](whats-new-in-aspnet-mvc-4/_static/image40.png "pressione Tab para selecionar o trecho de código realçado")</span><span class="sxs-lookup"><span data-stu-id="e315c-594">![Press Tab to select the highlighted snippet](whats-new-in-aspnet-mvc-4/_static/image40.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="e315c-595">*Pressione Tab para selecionar o trecho de código realçado*</span><span class="sxs-lookup"><span data-stu-id="e315c-595">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="e315c-596">![Pressione Tab novamente e o trecho expandirá](whats-new-in-aspnet-mvc-4/_static/image41.png "expandirá pressione Tab novamente e o trecho de código")</span><span class="sxs-lookup"><span data-stu-id="e315c-596">![Press Tab again and the snippet will expand](whats-new-in-aspnet-mvc-4/_static/image41.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="e315c-597">*Pressione Tab novamente e o trecho de código serão expandida*</span><span class="sxs-lookup"><span data-stu-id="e315c-597">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="e315c-598">***Para adicionar um trecho de código usando o mouse (c#, Visual Basic e XML)***</span><span class="sxs-lookup"><span data-stu-id="e315c-598">***To add a code snippet using the mouse (C#, Visual Basic and XML)***</span></span>

1. <span data-ttu-id="e315c-599">Clique com botão direito em que você deseja inserir o trecho de código.</span><span class="sxs-lookup"><span data-stu-id="e315c-599">Right-click where you want to insert the code snippet.</span></span>
2. <span data-ttu-id="e315c-600">Selecione **Inserir trecho** seguido por **Meus trechos de código**.</span><span class="sxs-lookup"><span data-stu-id="e315c-600">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
3. <span data-ttu-id="e315c-601">Selecione o trecho relevante na lista, clicando nele.</span><span class="sxs-lookup"><span data-stu-id="e315c-601">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="e315c-602">![Com o botão direito em que você deseja inserir o trecho de código e selecione Inserir trecho](whats-new-in-aspnet-mvc-4/_static/image42.png "com o botão direito em que você deseja inserir o trecho de código e selecione Inserir trecho")</span><span class="sxs-lookup"><span data-stu-id="e315c-602">![Right-click where you want to insert the code snippet and select Insert Snippet](whats-new-in-aspnet-mvc-4/_static/image42.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="e315c-603">*Clique com botão direito em que você deseja inserir o trecho de código e selecione Inserir trecho*</span><span class="sxs-lookup"><span data-stu-id="e315c-603">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="e315c-604">![Selecione o trecho relevante na lista, clicando nele](whats-new-in-aspnet-mvc-4/_static/image43.png "escolher o trecho relevante na lista, clicando nele")</span><span class="sxs-lookup"><span data-stu-id="e315c-604">![Pick the relevant snippet from the list, by clicking on it](whats-new-in-aspnet-mvc-4/_static/image43.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="e315c-605">*Selecione o trecho relevante na lista, clicando nele*</span><span class="sxs-lookup"><span data-stu-id="e315c-605">*Pick the relevant snippet from the list, by clicking on it*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-b-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="e315c-606">Apêndice b: instalar o Visual Studio Express 2012 para Web</span><span class="sxs-lookup"><span data-stu-id="e315c-606">Appendix B: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="e315c-607">Você pode instalar **Microsoft Visual Studio Express 2012 para Web** ou outro &quot;Express&quot; versão usando o  **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)** .</span><span class="sxs-lookup"><span data-stu-id="e315c-607">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="e315c-608">As instruções a seguir guiá-lo pelas etapas necessárias para instalar o *Visual studio Express 2012 para Web* usando *Microsoft Web Platform Installer*.</span><span class="sxs-lookup"><span data-stu-id="e315c-608">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="e315c-609">Vá para [ [https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="e315c-609">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="e315c-610">Como alternativa, se você já tiver instalado o Web Platform Installer, você pode abri-la e procure o produto &quot; *Visual Studio Express 2012 para Web com o SDK do Windows Azure*&quot;.</span><span class="sxs-lookup"><span data-stu-id="e315c-610">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;*Visual Studio Express 2012 for Web with Windows Azure SDK*&quot;.</span></span>
2. <span data-ttu-id="e315c-611">Clique em **instalar agora**.</span><span class="sxs-lookup"><span data-stu-id="e315c-611">Click on **Install Now**.</span></span> <span data-ttu-id="e315c-612">Se você não tem **Web Platform Installer** você será redirecionado para baixar e instalá-lo primeiro.</span><span class="sxs-lookup"><span data-stu-id="e315c-612">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="e315c-613">Uma vez **Web Platform Installer** é aberto, clique em **instalar** para iniciar a instalação.</span><span class="sxs-lookup"><span data-stu-id="e315c-613">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="e315c-614">![Instalar Visual Studio Express](whats-new-in-aspnet-mvc-4/_static/image44.png "instalar Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="e315c-614">![Install Visual Studio Express](whats-new-in-aspnet-mvc-4/_static/image44.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="e315c-615">*Instalar Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="e315c-615">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="e315c-616">Leia os termos e licenças de todos os produtos e clique em **aceito** para continuar.</span><span class="sxs-lookup"><span data-stu-id="e315c-616">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Aceitar os termos de licença](whats-new-in-aspnet-mvc-4/_static/image45.png)

    <span data-ttu-id="e315c-618">*Aceitar os termos de licença*</span><span class="sxs-lookup"><span data-stu-id="e315c-618">*Accepting the license terms*</span></span>
5. <span data-ttu-id="e315c-619">Aguarde até que o processo de download e instalação seja concluída.</span><span class="sxs-lookup"><span data-stu-id="e315c-619">Wait until the downloading and installation process completes.</span></span>

    ![Progresso da instalação](whats-new-in-aspnet-mvc-4/_static/image46.png)

    <span data-ttu-id="e315c-621">*Progresso da instalação*</span><span class="sxs-lookup"><span data-stu-id="e315c-621">*Installation progress*</span></span>
6. <span data-ttu-id="e315c-622">Quando a instalação for concluída, clique em **concluir**.</span><span class="sxs-lookup"><span data-stu-id="e315c-622">When the installation completes, click **Finish**.</span></span>

    ![Instalação concluída](whats-new-in-aspnet-mvc-4/_static/image47.png)

    <span data-ttu-id="e315c-624">*Instalação concluída*</span><span class="sxs-lookup"><span data-stu-id="e315c-624">*Installation completed*</span></span>
7. <span data-ttu-id="e315c-625">Clique em **saída** para fechar o Web Platform Installer.</span><span class="sxs-lookup"><span data-stu-id="e315c-625">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="e315c-626">Para abrir o Visual Studio Express para Web, vá para o **iniciar** tela e comece a escrever &quot; **VS Express**&quot;, em seguida, clique no **VS Express para Web** lado a lado.</span><span class="sxs-lookup"><span data-stu-id="e315c-626">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express para o bloco de Web](whats-new-in-aspnet-mvc-4/_static/image48.png)

    <span data-ttu-id="e315c-628">*VS Express para o bloco de Web*</span><span class="sxs-lookup"><span data-stu-id="e315c-628">*VS Express for Web tile*</span></span>

<a id="AppendixC"></a>

<a id="Appendix_C_Installing_WebMatrix_2_and_iPhone_Simulator"></a>
## <a name="appendix-c-installing-webmatrix-2-and-iphone-simulator"></a><span data-ttu-id="e315c-629">Apêndice c: Instalando o WebMatrix 2 e o simulador de iPhone</span><span class="sxs-lookup"><span data-stu-id="e315c-629">Appendix C: Installing WebMatrix 2 and iPhone Simulator</span></span>

<span data-ttu-id="e315c-630">Para executar o seu site em um dispositivo simulado iPhone, você pode usar a extensão do WebMatrix &quot;Electric simulador Mobile para iPhone&quot;.</span><span class="sxs-lookup"><span data-stu-id="e315c-630">To run your site in a simulated iPhone device you can use the WebMatrix extension &quot;Electric Mobile Simulator for the iPhone&quot;.</span></span> <span data-ttu-id="e315c-631">Além disso, você pode configurar a mesma extensão para executar o simulador do Visual Studio 2012.</span><span class="sxs-lookup"><span data-stu-id="e315c-631">Also, you can configure the same extension to run the simulator from Visual Studio 2012.</span></span>

<a id="ApxCTask1"></a>

<a id="Task_1_-_Installing_WebMatrix_2"></a>
#### <a name="task-1---installing-webmatrix-2"></a><span data-ttu-id="e315c-632">Tarefa 1: instalar o WebMatrix 2</span><span class="sxs-lookup"><span data-stu-id="e315c-632">Task 1 - Installing WebMatrix 2</span></span>

1. <span data-ttu-id="e315c-633">Vá para [ [https://go.microsoft.com/?linkid=9809776](https://go.microsoft.com/?linkid=9809776)](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="e315c-633">Go to [[https://go.microsoft.com/?linkid=9809776](https://go.microsoft.com/?linkid=9809776)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="e315c-634">Como alternativa, se você já tiver instalado o Web Platform Installer, você pode abri-la e procure o produto &quot; *o WebMatrix 2*&quot;.</span><span class="sxs-lookup"><span data-stu-id="e315c-634">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;*WebMatrix 2*&quot;.</span></span>
2. <span data-ttu-id="e315c-635">Clique em **instalar agora**.</span><span class="sxs-lookup"><span data-stu-id="e315c-635">Click on **Install Now**.</span></span> <span data-ttu-id="e315c-636">Se você não tem **Web Platform Installer** você será redirecionado para baixar e instalá-lo primeiro.</span><span class="sxs-lookup"><span data-stu-id="e315c-636">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="e315c-637">Uma vez **Web Platform Installer** é aberto, clique em **instalar** para iniciar a instalação.</span><span class="sxs-lookup"><span data-stu-id="e315c-637">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="e315c-638">![Instalar o WebMatrix 2](whats-new-in-aspnet-mvc-4/_static/image49.png "instalar o WebMatrix 2")</span><span class="sxs-lookup"><span data-stu-id="e315c-638">![Install WebMatrix 2](whats-new-in-aspnet-mvc-4/_static/image49.png "Install WebMatrix 2")</span></span>

    <span data-ttu-id="e315c-639">*Instalar o WebMatrix 2*</span><span class="sxs-lookup"><span data-stu-id="e315c-639">*Install WebMatrix 2*</span></span>
4. <span data-ttu-id="e315c-640">Leia os termos e licenças de todos os produtos e clique em **aceito** para continuar.</span><span class="sxs-lookup"><span data-stu-id="e315c-640">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    <span data-ttu-id="e315c-641">![Aceitar os termos de licença](whats-new-in-aspnet-mvc-4/_static/image50.png "aceitar os termos de licença")</span><span class="sxs-lookup"><span data-stu-id="e315c-641">![Accepting the license terms](whats-new-in-aspnet-mvc-4/_static/image50.png "Accepting the license terms")</span></span>

    <span data-ttu-id="e315c-642">*Aceitar os termos de licença*</span><span class="sxs-lookup"><span data-stu-id="e315c-642">*Accepting the license terms*</span></span>
5. <span data-ttu-id="e315c-643">Aguarde até que o processo de download e instalação seja concluída.</span><span class="sxs-lookup"><span data-stu-id="e315c-643">Wait until the downloading and installation process completes.</span></span>

    <span data-ttu-id="e315c-644">![Progresso da instalação](whats-new-in-aspnet-mvc-4/_static/image51.png "progresso da instalação")</span><span class="sxs-lookup"><span data-stu-id="e315c-644">![Installation progress](whats-new-in-aspnet-mvc-4/_static/image51.png "Installation progress")</span></span>

    <span data-ttu-id="e315c-645">*Progresso da instalação*</span><span class="sxs-lookup"><span data-stu-id="e315c-645">*Installation progress*</span></span>
6. <span data-ttu-id="e315c-646">Quando a instalação for concluída, clique em **concluir**.</span><span class="sxs-lookup"><span data-stu-id="e315c-646">When the installation completes, click **Finish**.</span></span>

    <span data-ttu-id="e315c-647">![Instalação concluída](whats-new-in-aspnet-mvc-4/_static/image52.png "instalação concluída")</span><span class="sxs-lookup"><span data-stu-id="e315c-647">![Installation completed](whats-new-in-aspnet-mvc-4/_static/image52.png "Installation completed")</span></span>

    <span data-ttu-id="e315c-648">*Instalação concluída*</span><span class="sxs-lookup"><span data-stu-id="e315c-648">*Installation completed*</span></span>
7. <span data-ttu-id="e315c-649">Clique em **saída** para fechar o Web Platform Installer.</span><span class="sxs-lookup"><span data-stu-id="e315c-649">Click **Exit** to close Web Platform Installer.</span></span>

<a id="ApxCTask2"></a>

<a id="Task_2_-_Installing_the_iPhone_Simulator_Extension"></a>
#### <a name="task-2---installing-the-iphone-simulator-extension"></a><span data-ttu-id="e315c-650">Tarefa 2 - instalar o extensão do simulador de iPhone</span><span class="sxs-lookup"><span data-stu-id="e315c-650">Task 2 - Installing the iPhone Simulator Extension</span></span>

1. <span data-ttu-id="e315c-651">Executar **WebMatrix** e abrir qualquer site existente ou criar um novo.</span><span class="sxs-lookup"><span data-stu-id="e315c-651">Run **WebMatrix** and open any existing Web site or create a new one.</span></span>
2. <span data-ttu-id="e315c-652">Clique o **executar** botão do **início** de faixa de opções e selecione **adicionar novo**.</span><span class="sxs-lookup"><span data-stu-id="e315c-652">Click the **Run** button from the **Home** ribbon and select **Add new**.</span></span>

    <span data-ttu-id="e315c-653">![Adicionar nova extensão do WebMatrix](whats-new-in-aspnet-mvc-4/_static/image53.png "adicionar nova extensão do WebMatrix")</span><span class="sxs-lookup"><span data-stu-id="e315c-653">![Adding new WebMatrix extension](whats-new-in-aspnet-mvc-4/_static/image53.png "Adding new WebMatrix extension")</span></span>

    <span data-ttu-id="e315c-654">*Adicionar nova extensão do WebMatrix*</span><span class="sxs-lookup"><span data-stu-id="e315c-654">*Adding new WebMatrix extension*</span></span>
3. <span data-ttu-id="e315c-655">Selecione **iPhone simulador** e clique em **instalar**.</span><span class="sxs-lookup"><span data-stu-id="e315c-655">Select **iPhone Simulator** and click **Install**.</span></span>

    <span data-ttu-id="e315c-656">![Procurando extensões WebMatrix](whats-new-in-aspnet-mvc-4/_static/image54.png "extensões de pesquisa no WebMatrix")</span><span class="sxs-lookup"><span data-stu-id="e315c-656">![Browsing WebMatrix extensions](whats-new-in-aspnet-mvc-4/_static/image54.png "Browsing WebMatrix extensions")</span></span>

    <span data-ttu-id="e315c-657">*Procurando extensões do WebMatrix*</span><span class="sxs-lookup"><span data-stu-id="e315c-657">*Browsing WebMatrix extensions*</span></span>
4. <span data-ttu-id="e315c-658">Nos detalhes do pacote, clique em **instalar** para continuar com a instalação da extensão.</span><span class="sxs-lookup"><span data-stu-id="e315c-658">In the package details, click **Install** to continue with the extension installation.</span></span>

    <span data-ttu-id="e315c-659">![extensão do simulador de iPhone](whats-new-in-aspnet-mvc-4/_static/image55.png "extensão simulador de iPhone")</span><span class="sxs-lookup"><span data-stu-id="e315c-659">![iPhone Simulator extension](whats-new-in-aspnet-mvc-4/_static/image55.png "iPhone Simulator extension")</span></span>

    <span data-ttu-id="e315c-660">*extensão do simulador de iPhone*</span><span class="sxs-lookup"><span data-stu-id="e315c-660">*iPhone Simulator extension*</span></span>
5. <span data-ttu-id="e315c-661">Leia e aceite o EULA de extensão.</span><span class="sxs-lookup"><span data-stu-id="e315c-661">Read and accept the extension EULA.</span></span>

    <span data-ttu-id="e315c-662">![Extensão do WebMatrix EULA](whats-new-in-aspnet-mvc-4/_static/image56.png "EULA de extensão do WebMatrix")</span><span class="sxs-lookup"><span data-stu-id="e315c-662">![WebMatrix extension EULA](whats-new-in-aspnet-mvc-4/_static/image56.png "WebMatrix extension EULA")</span></span>

    <span data-ttu-id="e315c-663">*Extensão do WebMatrix EULA*</span><span class="sxs-lookup"><span data-stu-id="e315c-663">*WebMatrix extension EULA*</span></span>
6. <span data-ttu-id="e315c-664">Agora, você pode executar o site do WebMatrix usando o opção de simulador de iPhone.</span><span class="sxs-lookup"><span data-stu-id="e315c-664">Now, you can run your Web site from WebMatrix using the iPhone Simulator option.</span></span>

    <span data-ttu-id="e315c-665">![Executar usando iPhone](whats-new-in-aspnet-mvc-4/_static/image57.png "executados usando iPhone")</span><span class="sxs-lookup"><span data-stu-id="e315c-665">![Run using iPhone](whats-new-in-aspnet-mvc-4/_static/image57.png "Run using iPhone")</span></span>

    <span data-ttu-id="e315c-666">*Executar usando iPhone*</span><span class="sxs-lookup"><span data-stu-id="e315c-666">*Run using iPhone*</span></span>

<a id="ApxCTask3"></a>

<a id="Task_3_-_Configuring_Visual_Studio_2012_to_run_iPhone_Simulator"></a>
#### <a name="task-3---configuring-visual-studio-2012-to-run-iphone-simulator"></a><span data-ttu-id="e315c-667">Tarefa 3: configurar o Visual Studio 2012 para executar o simulador de iPhone</span><span class="sxs-lookup"><span data-stu-id="e315c-667">Task 3 - Configuring Visual Studio 2012 to run iPhone Simulator</span></span>

1. <span data-ttu-id="e315c-668">Abra **Visual Studio 2012** e abrir qualquer site da Web ou criar um novo projeto.</span><span class="sxs-lookup"><span data-stu-id="e315c-668">Open **Visual Studio 2012** and open any Web site or create a new project.</span></span>
2. <span data-ttu-id="e315c-669">Clique na seta para baixo no botão Executar e selecione **procurar com**.</span><span class="sxs-lookup"><span data-stu-id="e315c-669">Click the down arrow from the Run button and select **Browse with**.</span></span>

    <span data-ttu-id="e315c-670">![Procurar com](whats-new-in-aspnet-mvc-4/_static/image58.png "procurar com")</span><span class="sxs-lookup"><span data-stu-id="e315c-670">![Browse with](whats-new-in-aspnet-mvc-4/_static/image58.png "Browse with")</span></span>

    <span data-ttu-id="e315c-671">*Procurar com*</span><span class="sxs-lookup"><span data-stu-id="e315c-671">*Browse with*</span></span>
3. <span data-ttu-id="e315c-672">No &quot;procurar com&quot; caixa de diálogo, clique em **adicionar**.</span><span class="sxs-lookup"><span data-stu-id="e315c-672">In the &quot;Browse With&quot; dialog, click **Add**.</span></span>
4. <span data-ttu-id="e315c-673">No &quot;adicionar programa&quot; caixa de diálogo, use os seguintes valores:</span><span class="sxs-lookup"><span data-stu-id="e315c-673">In the &quot;Add Program&quot; dialog, use the following values:</span></span>

    - <span data-ttu-id="e315c-674">**Programa**: C:\Users\*{CurrentUser}*\AppData\Local\Microsoft\WebMatrix\Extensions\20\iPhoneSimulator\ElectricMobileSim\ElectricMobileSim.exe *(adequadamente o caminho de atualização)*</span><span class="sxs-lookup"><span data-stu-id="e315c-674">**Program**: C:\Users\*{CurrentUser}*\AppData\Local\Microsoft\WebMatrix\Extensions\20\iPhoneSimulator\ElectricMobileSim\ElectricMobileSim.exe *(update the path accordingly)*</span></span>
    - <span data-ttu-id="e315c-675">**Argumentos**: &quot;1&quot;</span><span class="sxs-lookup"><span data-stu-id="e315c-675">**Arguments**: &quot;1&quot;</span></span>
    - <span data-ttu-id="e315c-676">**Nome amigável**: simulador de iPhone</span><span class="sxs-lookup"><span data-stu-id="e315c-676">**Friendly name**: iPhone Simulator</span></span>

    <span data-ttu-id="e315c-677">![Adicionar programa](whats-new-in-aspnet-mvc-4/_static/image59.png "adicionar programa")</span><span class="sxs-lookup"><span data-stu-id="e315c-677">![Add program](whats-new-in-aspnet-mvc-4/_static/image59.png "Add program")</span></span>

    <span data-ttu-id="e315c-678">*Adicionar programa para procurar com*</span><span class="sxs-lookup"><span data-stu-id="e315c-678">*Add program to browse with*</span></span>
5. <span data-ttu-id="e315c-679">Clique em **Okey** e feche as caixas de diálogo.</span><span class="sxs-lookup"><span data-stu-id="e315c-679">Click **OK** and close the dialogs.</span></span>
6. <span data-ttu-id="e315c-680">Agora é possível executar seus aplicativos Web no iPhone simulador do Visual Studio 2012.</span><span class="sxs-lookup"><span data-stu-id="e315c-680">Now you are able to run your Web applications in the iPhone simulator from Visual Studio 2012.</span></span>

    <span data-ttu-id="e315c-681">![Procurar com iPhone simulador](whats-new-in-aspnet-mvc-4/_static/image60.png "procurar com simulador de iPhone")</span><span class="sxs-lookup"><span data-stu-id="e315c-681">![Browse with iPhone Simulator](whats-new-in-aspnet-mvc-4/_static/image60.png "Browse with iPhone Simulator")</span></span>

    <span data-ttu-id="e315c-682">*Procurar com simulador de iPhone*</span><span class="sxs-lookup"><span data-stu-id="e315c-682">*Browse with iPhone Simulator*</span></span>

<a id="AppendixD"></a>

<a id="Appendix_D_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
## <a name="appendix-d-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="e315c-683">Apêndice d: publicar um aplicativo ASP.NET MVC 4 usando a implantação da Web</span><span class="sxs-lookup"><span data-stu-id="e315c-683">Appendix D: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="e315c-684">Este apêndice mostram como criar um novo site do Portal de gerenciamento do Windows Azure e publicar o aplicativo que você obteve seguindo o laboratório, aproveitando o recurso de publicação de implantação da Web fornecido pelo Windows Azure.</span><span class="sxs-lookup"><span data-stu-id="e315c-684">This appendix will show you how to create a new web site from the Windows Azure Management Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Windows Azure.</span></span>

<a id="ApxDTask1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-windows-azure-portal"></a><span data-ttu-id="e315c-685">Tarefa 1: criar um novo Site do Windows Azure Portal</span><span class="sxs-lookup"><span data-stu-id="e315c-685">Task 1 - Creating a New Web Site from the Windows Azure Portal</span></span>

1. <span data-ttu-id="e315c-686">Vá para o [Portal de gerenciamento do Windows Azure](https://manage.windowsazure.com/) e entre usando as credenciais da Microsoft associadas à sua assinatura.</span><span class="sxs-lookup"><span data-stu-id="e315c-686">Go to the [Windows Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e315c-687">Com o Windows Azure, você pode hospedar 10 Sites da Web ASP.NET gratuitamente e, em seguida, dimensione conforme seu tráfego cresce.</span><span class="sxs-lookup"><span data-stu-id="e315c-687">With Windows Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="e315c-688">Você pode inscrever [aqui](http://aka.ms/aspnet-hol-azure).</span><span class="sxs-lookup"><span data-stu-id="e315c-688">You can sign up [here](http://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="e315c-689">![Faça logon no portal do Windows Azure](whats-new-in-aspnet-mvc-4/_static/image61.png "faça logon no portal do Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="e315c-689">![Log on to Windows Azure portal](whats-new-in-aspnet-mvc-4/_static/image61.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="e315c-690">*Faça logon no Portal de gerenciamento do Azure do Windows*</span><span class="sxs-lookup"><span data-stu-id="e315c-690">*Log on to Windows Azure Management Portal*</span></span>
2. <span data-ttu-id="e315c-691">Clique em **novo** na barra de comandos.</span><span class="sxs-lookup"><span data-stu-id="e315c-691">Click **New** on the command bar.</span></span>

    <span data-ttu-id="e315c-692">![Criando um novo Site](whats-new-in-aspnet-mvc-4/_static/image62.png "criar um novo Site")</span><span class="sxs-lookup"><span data-stu-id="e315c-692">![Creating a new Web Site](whats-new-in-aspnet-mvc-4/_static/image62.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="e315c-693">*Criando um novo Site*</span><span class="sxs-lookup"><span data-stu-id="e315c-693">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="e315c-694">Clique em **de computação** | **Site da Web**.</span><span class="sxs-lookup"><span data-stu-id="e315c-694">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="e315c-695">Em seguida, selecione **criação rápida** opção.</span><span class="sxs-lookup"><span data-stu-id="e315c-695">Then select **Quick Create** option.</span></span> <span data-ttu-id="e315c-696">Forneça uma URL disponível para o novo site e clique em **Criar Site**.</span><span class="sxs-lookup"><span data-stu-id="e315c-696">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e315c-697">Um Site do Windows Azure é o host para um aplicativo web em execução na nuvem que você pode controlar e gerenciar.</span><span class="sxs-lookup"><span data-stu-id="e315c-697">A Windows Azure Web Site is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="e315c-698">A opção criação rápida permite que você implante um aplicativo web concluído ao Site do Windows Azure de fora do portal.</span><span class="sxs-lookup"><span data-stu-id="e315c-698">The Quick Create option allows you to deploy a completed web application to the Windows Azure Web Site from outside the portal.</span></span> <span data-ttu-id="e315c-699">Ele não inclui etapas para configurar um banco de dados.</span><span class="sxs-lookup"><span data-stu-id="e315c-699">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="e315c-700">![Criando um novo Site usando a criação rápida](whats-new-in-aspnet-mvc-4/_static/image63.png "criar um novo Site usando a criação rápida")</span><span class="sxs-lookup"><span data-stu-id="e315c-700">![Creating a new Web Site using Quick Create](whats-new-in-aspnet-mvc-4/_static/image63.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="e315c-701">*Criando um novo Site usando a criação rápida*</span><span class="sxs-lookup"><span data-stu-id="e315c-701">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="e315c-702">Aguarde até que o novo **Site da Web** é criado.</span><span class="sxs-lookup"><span data-stu-id="e315c-702">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="e315c-703">Depois que o Site da Web é criado, clique no link sob a **URL** coluna.</span><span class="sxs-lookup"><span data-stu-id="e315c-703">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="e315c-704">Verifique se o novo Site da Web está funcionando.</span><span class="sxs-lookup"><span data-stu-id="e315c-704">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="e315c-705">![Navegando para o novo site](whats-new-in-aspnet-mvc-4/_static/image64.png "navegando para o novo site")</span><span class="sxs-lookup"><span data-stu-id="e315c-705">![Browsing to the new web site](whats-new-in-aspnet-mvc-4/_static/image64.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="e315c-706">*Navegando para o novo site*</span><span class="sxs-lookup"><span data-stu-id="e315c-706">*Browsing to the new web site*</span></span>

    <span data-ttu-id="e315c-707">![Site da Web em execução](whats-new-in-aspnet-mvc-4/_static/image65.png "site em execução")</span><span class="sxs-lookup"><span data-stu-id="e315c-707">![Web site running](whats-new-in-aspnet-mvc-4/_static/image65.png "Web site running")</span></span>

    <span data-ttu-id="e315c-708">*Site da Web em execução*</span><span class="sxs-lookup"><span data-stu-id="e315c-708">*Web site running*</span></span>
6. <span data-ttu-id="e315c-709">Acesse o portal e clique no nome do site sob o **nome** coluna para exibir as páginas de gerenciamento.</span><span class="sxs-lookup"><span data-stu-id="e315c-709">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="e315c-710">![Abrir as páginas de gerenciamento do site da web](whats-new-in-aspnet-mvc-4/_static/image66.png "abrir páginas de gerenciamento do site")</span><span class="sxs-lookup"><span data-stu-id="e315c-710">![Opening the web site management pages](whats-new-in-aspnet-mvc-4/_static/image66.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="e315c-711">*Abrir as páginas de gerenciamento do Site da Web*</span><span class="sxs-lookup"><span data-stu-id="e315c-711">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="e315c-712">No **painel** página no **visão rápida** seção, clique o **baixar perfil de publicação** link.</span><span class="sxs-lookup"><span data-stu-id="e315c-712">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e315c-713">O *perfil de publicação* contém todas as informações necessárias para publicar um aplicativo web para um site do Windows Azure para cada método de publicação habilitado.</span><span class="sxs-lookup"><span data-stu-id="e315c-713">The *publish profile* contains all of the information required to publish a web application to a Windows Azure website for each enabled publication method.</span></span> <span data-ttu-id="e315c-714">O perfil de publicação contém as URLs, as credenciais do usuário e cadeias de caracteres de banco de dados necessárias para se conectar e autenticar cada um dos pontos de extremidade para o qual um método de publicação está habilitado.</span><span class="sxs-lookup"><span data-stu-id="e315c-714">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="e315c-715">**Microsoft WebMatrix 2**, **Microsoft Visual Studio para Web Express** e **Microsoft Visual Studio 2012** oferecem suporte à leitura perfis de publicação para automatizar a configuração desses programas para publicação de aplicativos web para sites do Windows Azure.</span><span class="sxs-lookup"><span data-stu-id="e315c-715">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Windows Azure websites.</span></span>

    <span data-ttu-id="e315c-716">![Baixando o site da web de perfil de publicação](whats-new-in-aspnet-mvc-4/_static/image67.png "baixando o site da web de perfil de publicação")</span><span class="sxs-lookup"><span data-stu-id="e315c-716">![Downloading the web site publish profile](whats-new-in-aspnet-mvc-4/_static/image67.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="e315c-717">*Baixando o Site da Web de perfil de publicação*</span><span class="sxs-lookup"><span data-stu-id="e315c-717">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="e315c-718">Baixe o arquivo de perfil de publicação para um local conhecido.</span><span class="sxs-lookup"><span data-stu-id="e315c-718">Download the publish profile file to a known location.</span></span> <span data-ttu-id="e315c-719">Mais neste exercício, você verá como usar esse arquivo para publicar um aplicativo web para um Windows Azure Web Sites do Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="e315c-719">Further in this exercise you will see how to use this file to publish a web application to a Windows Azure Web Sites from Visual Studio.</span></span>

    <span data-ttu-id="e315c-720">![Salvando o arquivo de perfil de publicação](whats-new-in-aspnet-mvc-4/_static/image68.png "salvar o perfil de publicação")</span><span class="sxs-lookup"><span data-stu-id="e315c-720">![Saving the publish profile file](whats-new-in-aspnet-mvc-4/_static/image68.png "Saving the publish profile")</span></span>

    <span data-ttu-id="e315c-721">*Salvando o arquivo de perfil de publicação*</span><span class="sxs-lookup"><span data-stu-id="e315c-721">*Saving the publish profile file*</span></span>

<a id="ApxDTask2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="e315c-722">Tarefa 2 – Configurando o servidor de banco de dados</span><span class="sxs-lookup"><span data-stu-id="e315c-722">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="e315c-723">Se seu aplicativo utiliza o SQL Server bancos de dados que você precisará criar um servidor de banco de dados SQL.</span><span class="sxs-lookup"><span data-stu-id="e315c-723">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="e315c-724">Se você deseja implantar um aplicativo simples que não usa o SQL Server, você pode ignorar esta tarefa.</span><span class="sxs-lookup"><span data-stu-id="e315c-724">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="e315c-725">Você precisará de um servidor de banco de dados SQL para armazenar o banco de dados do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="e315c-725">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="e315c-726">Você pode exibir os servidores de banco de dados SQL de sua assinatura no portal de gerenciamento do Windows Azure em **bancos de dados Sql** | **servidores** | **do servidor Painel**.</span><span class="sxs-lookup"><span data-stu-id="e315c-726">You can view the SQL Database servers from your subscription in the Windows Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="e315c-727">Se você não tiver um servidor criado, você pode criar um usando o **adicionar** botão na barra de comandos.</span><span class="sxs-lookup"><span data-stu-id="e315c-727">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="e315c-728">Anote o **nome do servidor e o URL, o nome de logon de administrador e senha**, pois você usará nas próximas tarefas.</span><span class="sxs-lookup"><span data-stu-id="e315c-728">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="e315c-729">Não crie o banco de dados, como ele será criado em um estágio posterior.</span><span class="sxs-lookup"><span data-stu-id="e315c-729">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="e315c-730">![Painel do servidor de banco de dados SQL](whats-new-in-aspnet-mvc-4/_static/image69.png "painel de banco de dados do SQL Server")</span><span class="sxs-lookup"><span data-stu-id="e315c-730">![SQL Database Server Dashboard](whats-new-in-aspnet-mvc-4/_static/image69.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="e315c-731">*Painel de banco de dados do SQL Server*</span><span class="sxs-lookup"><span data-stu-id="e315c-731">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="e315c-732">A próxima tarefa, você testará a conexão de banco de dados do Visual Studio, por esse motivo, você precisa incluir seu endereço IP local na lista do servidor de **endereços IP permitidos**.</span><span class="sxs-lookup"><span data-stu-id="e315c-732">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="e315c-733">Para fazer isso, clique em **configurar**, selecione o endereço IP do **endereço IP do cliente atual** e cole-o no **endereço IP inicial** e **oendereçoIPfinal** caixas de texto e clique no ![add-client-ip-address-ok-button](whats-new-in-aspnet-mvc-4/_static/image70.png) botão.</span><span class="sxs-lookup"><span data-stu-id="e315c-733">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes and click the ![add-client-ip-address-ok-button](whats-new-in-aspnet-mvc-4/_static/image70.png) button.</span></span>

    ![Adicionar endereço IP do cliente](whats-new-in-aspnet-mvc-4/_static/image71.png)

    <span data-ttu-id="e315c-735">*Adicionar endereço IP do cliente*</span><span class="sxs-lookup"><span data-stu-id="e315c-735">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="e315c-736">Uma vez o **endereço IP do cliente** é adicionado para os endereços IP permitidos, clique em **salvar** para confirmar as alterações.</span><span class="sxs-lookup"><span data-stu-id="e315c-736">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![Confirmar alterações](whats-new-in-aspnet-mvc-4/_static/image72.png)

    <span data-ttu-id="e315c-738">*Confirmar alterações*</span><span class="sxs-lookup"><span data-stu-id="e315c-738">*Confirm Changes*</span></span>

<a id="ApxDTask3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="e315c-739">Tarefa 3: publicar um aplicativo ASP.NET MVC 4 usando a implantação da Web</span><span class="sxs-lookup"><span data-stu-id="e315c-739">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="e315c-740">Volte para a solução do ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="e315c-740">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="e315c-741">No **Solution Explorer**, com o botão direito no projeto de site da web e selecione **publicar**.</span><span class="sxs-lookup"><span data-stu-id="e315c-741">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="e315c-742">![Publicar o aplicativo](whats-new-in-aspnet-mvc-4/_static/image73.png "a publicação do aplicativo")</span><span class="sxs-lookup"><span data-stu-id="e315c-742">![Publishing the Application](whats-new-in-aspnet-mvc-4/_static/image73.png "Publishing the Application")</span></span>

    <span data-ttu-id="e315c-743">*Publicar o site*</span><span class="sxs-lookup"><span data-stu-id="e315c-743">*Publishing the web site*</span></span>
2. <span data-ttu-id="e315c-744">Importe o perfil de publicação que você salvou na primeira tarefa.</span><span class="sxs-lookup"><span data-stu-id="e315c-744">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="e315c-745">![Importar o perfil de publicação](whats-new-in-aspnet-mvc-4/_static/image74.png "importar o perfil de publicação")</span><span class="sxs-lookup"><span data-stu-id="e315c-745">![Importing the publish profile](whats-new-in-aspnet-mvc-4/_static/image74.png "Importing the publish profile")</span></span>

    <span data-ttu-id="e315c-746">*Importar o perfil de publicação*</span><span class="sxs-lookup"><span data-stu-id="e315c-746">*Importing publish profile*</span></span>
3. <span data-ttu-id="e315c-747">Clique em **validar Conexão**.</span><span class="sxs-lookup"><span data-stu-id="e315c-747">Click **Validate Connection**.</span></span> <span data-ttu-id="e315c-748">Quando a validação estiver concluída, clique em **próximo**.</span><span class="sxs-lookup"><span data-stu-id="e315c-748">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="e315c-749">A validação é concluída depois que aparecer uma marca de seleção verde ao lado do botão Validar Conexão.</span><span class="sxs-lookup"><span data-stu-id="e315c-749">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="e315c-750">![Validando a conexão](whats-new-in-aspnet-mvc-4/_static/image75.png "validação de conexão")</span><span class="sxs-lookup"><span data-stu-id="e315c-750">![Validating connection](whats-new-in-aspnet-mvc-4/_static/image75.png "Validating connection")</span></span>

    <span data-ttu-id="e315c-751">*Validação de conexão*</span><span class="sxs-lookup"><span data-stu-id="e315c-751">*Validating connection*</span></span>
4. <span data-ttu-id="e315c-752">No **configurações** página no **bancos de dados** seção, clique no botão ao lado da caixa de texto da sua conexão de banco de dados (ou seja, **DefaultConnection**).</span><span class="sxs-lookup"><span data-stu-id="e315c-752">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="e315c-753">![Configuração de implantação da Web](whats-new-in-aspnet-mvc-4/_static/image76.png "configuração de implantação da Web")</span><span class="sxs-lookup"><span data-stu-id="e315c-753">![Web deploy configuration](whats-new-in-aspnet-mvc-4/_static/image76.png "Web deploy configuration")</span></span>

    <span data-ttu-id="e315c-754">*Configuração de implantação da Web*</span><span class="sxs-lookup"><span data-stu-id="e315c-754">*Web deploy configuration*</span></span>
5. <span data-ttu-id="e315c-755">Configure a conexão de banco de dados da seguinte maneira:</span><span class="sxs-lookup"><span data-stu-id="e315c-755">Configure the database connection as follows:</span></span>

    - <span data-ttu-id="e315c-756">No **nome do servidor** digite sua URL de servidor de banco de dados SQL usando o *tcp:* prefixo.</span><span class="sxs-lookup"><span data-stu-id="e315c-756">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
    - <span data-ttu-id="e315c-757">Em **nome de usuário** digite seu nome de logon de administrador do servidor.</span><span class="sxs-lookup"><span data-stu-id="e315c-757">In **User name** type your server administrator login name.</span></span>
    - <span data-ttu-id="e315c-758">Em **senha** digite sua senha de logon de administrador do servidor.</span><span class="sxs-lookup"><span data-stu-id="e315c-758">In **Password** type your server administrator login password.</span></span>
    - <span data-ttu-id="e315c-759">Digite um novo nome de banco de dados, por exemplo: *MVC4SampleDB*.</span><span class="sxs-lookup"><span data-stu-id="e315c-759">Type a new database name, for example: *MVC4SampleDB*.</span></span>

    <span data-ttu-id="e315c-760">![Configurando a cadeia de caracteres de conexão de destino](whats-new-in-aspnet-mvc-4/_static/image77.png "Configurando a cadeia de caracteres de conexão de destino")</span><span class="sxs-lookup"><span data-stu-id="e315c-760">![Configuring destination connection string](whats-new-in-aspnet-mvc-4/_static/image77.png "Configuring destination connection string")</span></span>

    <span data-ttu-id="e315c-761">*Configurando a cadeia de caracteres de conexão de destino*</span><span class="sxs-lookup"><span data-stu-id="e315c-761">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="e315c-762">Clique em **OK**.</span><span class="sxs-lookup"><span data-stu-id="e315c-762">Then click **OK**.</span></span> <span data-ttu-id="e315c-763">Quando solicitado a criar o banco de dados, clique em **Sim**.</span><span class="sxs-lookup"><span data-stu-id="e315c-763">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="e315c-764">![Criando o banco de dados](whats-new-in-aspnet-mvc-4/_static/image78.png "criar a cadeia de caracteres do banco de dados")</span><span class="sxs-lookup"><span data-stu-id="e315c-764">![Creating the database](whats-new-in-aspnet-mvc-4/_static/image78.png "Creating the database string")</span></span>

    <span data-ttu-id="e315c-765">*Criando o banco de dados*</span><span class="sxs-lookup"><span data-stu-id="e315c-765">*Creating the database*</span></span>
7. <span data-ttu-id="e315c-766">A cadeia de caracteres de conexão que você usará para se conectar ao banco de dados SQL no Windows Azure é mostrada na caixa de texto de Conexão padrão.</span><span class="sxs-lookup"><span data-stu-id="e315c-766">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="e315c-767">Clique em **Avançar**.</span><span class="sxs-lookup"><span data-stu-id="e315c-767">Then click **Next**.</span></span>

    <span data-ttu-id="e315c-768">![Cadeia de caracteres de Conexão que aponta para o banco de dados SQL](whats-new-in-aspnet-mvc-4/_static/image79.png "cadeia de caracteres de Conexão que aponta para o banco de dados SQL")</span><span class="sxs-lookup"><span data-stu-id="e315c-768">![Connection string pointing to SQL Database](whats-new-in-aspnet-mvc-4/_static/image79.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="e315c-769">*Cadeia de caracteres de Conexão que aponta para o banco de dados SQL*</span><span class="sxs-lookup"><span data-stu-id="e315c-769">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="e315c-770">No **visualização** , clique em **publicar**.</span><span class="sxs-lookup"><span data-stu-id="e315c-770">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="e315c-771">![Publicar o aplicativo web](whats-new-in-aspnet-mvc-4/_static/image80.png "publicar o aplicativo web")</span><span class="sxs-lookup"><span data-stu-id="e315c-771">![Publishing the web application](whats-new-in-aspnet-mvc-4/_static/image80.png "Publishing the web application")</span></span>

    <span data-ttu-id="e315c-772">*Publicar o aplicativo web*</span><span class="sxs-lookup"><span data-stu-id="e315c-772">*Publishing the web application*</span></span>
9. <span data-ttu-id="e315c-773">Quando termina o processo de publicação, o navegador padrão abrirá o site da web publicado.</span><span class="sxs-lookup"><span data-stu-id="e315c-773">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="e315c-774">![Aplicativo publicado no Windows Azure](whats-new-in-aspnet-mvc-4/_static/image81.png "aplicativo publicado no Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="e315c-774">![Application published to Windows Azure](whats-new-in-aspnet-mvc-4/_static/image81.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="e315c-775">*Aplicativos publicados no Windows Azure*</span><span class="sxs-lookup"><span data-stu-id="e315c-775">*Application published to Windows Azure*</span></span>
