...
> 
> O artigo supõe que você já tiver algum conhecimento dos eventos de tempo de vida do SignalR e conexão. Para obter uma introdução ao SignalR, consulte [SignalR - visão geral – guia de Introdução](index.md). Para listas de eventos de tempo de vida da conexão, consulte os seguintes recursos:
> 
> - [Como manipular eventos de tempo de vida da conexão na classe Hub](index.md)
> - [Como manipular eventos de tempo de vida da conexão em clientes de JavaScript](index.md)
