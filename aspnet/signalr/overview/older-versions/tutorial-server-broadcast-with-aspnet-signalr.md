...
### <a name="add-the-signalr-and-jquery-nuget-packages"></a>Adicione o SignalR e pacotes do JQuery NuGet
...
1. Em **Solution Explorer**, clique com o botão direito e clique em **Adicionar Novo Item**.
