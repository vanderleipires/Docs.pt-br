...
A biblioteca do servidor SignalR está incluída no [Metapacote Microsoft.AspNetCore.App](xref:fundamentals/metapackage-app). Mas você precisa obter a biblioteca de clientes JavaScript do npm, ou seja, o gerenciador de pacotes do Node.js.
