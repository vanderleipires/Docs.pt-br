...
keywords: "ASP.NET Core,validação,DataAnnotations"
ms.author: riande
manager: wpickett
ms.date: 04/13/2017
...
<span data-ttu-id="6c99c-104">[Anterior – Adicionar um campo](new-field.md)
[Próximo – Examinar os métodos Details e Delete](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="6c99c-104">[Previous - Add a field](new-field.md)
