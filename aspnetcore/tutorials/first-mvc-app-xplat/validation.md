...
ms.locfileid: "36273592"
---
[!INCLUDE [validation](../../includes/mvc-intro/validation.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="2e94a-103">[Anterior – Adicionar um campo](new-field.md)
> [Próximo – Examinar os métodos Details e Delete](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="2e94a-103">[Previous - Add a field](new-field.md)
