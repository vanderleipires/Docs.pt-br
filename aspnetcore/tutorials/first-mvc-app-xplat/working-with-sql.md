...
<span data-ttu-id="03ea7-104">[Anterior – Adicionar um modelo](adding-model.md)
[Próximo – Exibições e métodos do controlador](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="03ea7-104">[Previous - Add a model](adding-model.md)
