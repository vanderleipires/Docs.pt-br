...
ms.locfileid: "36960626"
---
[!INCLUDE [SQLlite](../../includes/RP/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="efbab-103">[Anterior: adicionando um modelo](xref:tutorials/razor-pages-vsc/model)
> [Próximo: atualizar as páginas](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="efbab-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
