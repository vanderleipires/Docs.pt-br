...
---
# <a name="adding-a-controller-to-a-aspnet-core-mvc-app-with-visual-studio"></a>Adicionando um controlador a um aplicativo ASP.NET Core MVC com o Visual Studio
