...
## [Criar um aplicativo Web de Páginas do Razor no Windows](xref:tutorials/razor-pages/index)
...
### [Adicionando uma Validação](tutorials/first-mvc-app-mac/validation.md)
### [Examinando os métodos Details e Delete](tutorials/first-mvc-app/details.md)
...
## [Teste de integração](testing/integration-testing.md)
## [Testando os controladores](mvc/controllers/testing.md)
## [Depuração remota](https://docs.microsoft.com/visualstudio/debugger/remote-debugging-azure)
## [Depuração de Instantâneo](https://docs.microsoft.com/azure/application-insights/app-insights-snapshot-debugger)
...
## [Criando projetos com o Yeoman](xref:client-side/yeoman)
...
####[Detalhes da criptografia autenticada.](xref:security/data-protection/implementation/authenticated-encryption-details)
