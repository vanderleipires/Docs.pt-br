...
---
# <a name="aspnet-core-middleware-fundamentals"></a>Conceitos básicos do middleware do ASP.NET Core
...
A seção [Migrando módulos HTTP para o middleware](../migration/http-modules.md) explica a diferença entre pipelines de solicitação no ASP.NET Core e as versões anteriores e fornece mais amostras do middleware.
...
| [Reconfiguração de URL ](xref:fundamentals/url-rewriting) | Fornece suporte para regravar URLs e redirecionar solicitações. | Antes dos componentes que consomem a URL. |
...
## <a name="writing-middleware"></a>Escrevendo um middleware
...
* [Código de exemplo usado neste documento](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/middleware/sample)
