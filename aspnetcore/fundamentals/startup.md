...
O `Startup` construtor de classe aceita dependências definidas pelo host. Um uso comum de [injeção de dependência](xref:fundamentals/dependency-injection) para o `Startup` classe é injetar:
