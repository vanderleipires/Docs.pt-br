# <a name="aspnet-core-url-rewriting-sample-aspnet-core-1x"></a>Exemplo de regravação de URL de núcleo do ASP.NET (ASP.NET Core 1. x)

Este exemplo ilustra o uso do núcleo do ASP.NET 1. x Middleware de regravação de URL. O aplicativo demonstra o redirecionamento de URL e opções de regravação de URL. Para o exemplo do ASP.NET Core 2. x, consulte [exemplo de regravação de URL do ASP.NET Core (ASP.NET Core 2. x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/url-rewriting/samples/2.x).
