# <a name="aspnet-core-url-rewriting-sample-aspnet-core-1x"></a>Amostra de reconfiguração de URL do ASP.NET Core (ASP.NET Core 1.x)

Esta amostra ilustra o uso do Middleware de Reconfiguração de URL do ASP.NET Core 1.x. O aplicativo demonstra as opções de redirecionamento e reconfiguração de URL. Para obter a amostra do ASP.NET Core 2.x, consulte [Amostra de reconfiguração de URL do ASP.NET Core (ASP.NET Core 2.x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/url-rewriting/samples/2.x).
