...
Para obter mais informações, veja [Como tratar erros](xref:fundamentals/error-handling).
...
Saiba mais em [Tarefas em segundo plano com serviços hospedados](xref:fundamentals/hosted-services).
