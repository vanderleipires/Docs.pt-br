...
2. Use o Cloud Shell para as etapas a seguir.
    ...
    O `az` comando invoca o [CLI do Azure](/cli/azure/). A CLI pode ser executada localmente, mas usá-lo no Cloud Shell economiza tempo e configuração.
