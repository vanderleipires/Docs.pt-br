...
* Um *modelo* é um objeto que representa os dados no aplicativo. Nesse caso, o único modelo é um item de tarefas pendentes. Os modelos são representados como classes C#, também conhecidas como POCOs (**P**lain **O**ld **C**# **O**bject).
