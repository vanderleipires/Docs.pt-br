...
- Normalmente não deve ser usado para converter uma cadeia de caracteres em um tipo personalizado, uma [ `TypeConverter` ](https://msdn.microsoft.com/library/ayybcxe5.aspx) geralmente é uma opção melhor.
