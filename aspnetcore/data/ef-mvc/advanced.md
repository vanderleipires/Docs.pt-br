...
---
# <a name="advanced-topics---ef-core-with-aspnet-core-mvc-tutorial-10-of-10"></a>Tópicos avançados – tutorial do EF Core com o ASP.NET Core MVC (10 de 10)
...
O Entity Framework Core implementa um provedor de banco de dados em memória que pode ser usado para teste. Para obter mais informações, consulte [Testando com InMemory](https://docs.microsoft.com/ef/core/miscellaneous/testing/in-memory).
...
A fonte do Entity Framework Core está localizada em [https://github.com/aspnet/EntityFrameworkCore](https://github.com/aspnet/EntityFrameworkCore). O repositório do EF Core contém builds noturnos, acompanhamento de questões, especificações de recurso, notas de reuniões de design e [o roteiro para desenvolvimento futuro](https://github.com/aspnet/EntityFrameworkCore/wiki/Roadmap). Arquive ou encontre bugs e contribua.
...
Para obter informações sobre outros tópicos relacionados ao ASP.NET Core MVC, como autenticação e autorização, consulte a [documentação do ASP.NET Core](https://docs.microsoft.com/aspnet/core/).
