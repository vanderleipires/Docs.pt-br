---
title: "Provedor de configuração do Cofre de chaves do Azure"
author: guardrex
...
keywords: "ASP.NET Core, configuração, o Cofre de chaves do Azure"
ms.author: riande
manager: wpickett
ms.date: 08/09/2017
ms.topic: article
...
[!code-csharp[Construtor de configuração](key-vault-configuration/samples/key-name-prefix-sample/2.x/Program.cs?name=snippet1&highlight=12)]
