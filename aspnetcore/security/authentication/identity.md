...
Serviços são adicionados no `ConfigureServices`.
...
Siga as [criar o scaffolding de identidade em um projeto do Razor com autorização](xref:security/authentication/scaffold-identity#) instruções.
