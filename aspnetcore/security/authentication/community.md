...
| [Cierge](https://github.com/pwdless/Cierge) | Cierge é um servidor de OpenID Connect que manipula a inscrição de usuário, logon, perfis, gerenciamento e logons sociais. |
| [Servidor Gluu](https://gluu.org/) | Enterprise estiver pronto, abra o software de origem para a identidade, gerenciamento de acesso (IAM) e logon único (SSO). Para obter mais informações, consulte o [documentação do produto Gluu](https://gluu.org/docs/). |
