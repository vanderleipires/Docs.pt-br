...
## <a name="trust-the-aspnet-core-https-development-certificate-on-windows-and-macos"></a>Confiar no certificado de desenvolvimento do ASP.NET Core HTTPS no Windows e macOS
