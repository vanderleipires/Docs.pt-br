...
No seu configurar o uso do método CookieAuthenticationOptions para configurar o serviço de proteção de dados para cookies e AuthenticationScheme para coincidir com o ASP.NET 4. x.
