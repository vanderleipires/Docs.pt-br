# <a name="key-vault-configuration-provider-sample-application-aspnet-core-2x"></a>Aplicativo de exemplo do provedor de configuração do Cofre de chave (ASP.NET Core 2. x)

Este exemplo ilustra o uso do provedor de configuração do Cofre de chave do Azure para o ASP.NET Core 2. x. Para o exemplo de 1. x do ASP.NET Core, consulte [aplicativo de exemplo do provedor de configuração do Cofre de chave (ASP.NET Core 1. x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/security/key-vault-configuration/samples/basic-sample/1.x).
