...
Instalar **um** das seguintes opções de [.NET Downloads: Windows](https://www.microsoft.com/net/download/windows):

* SDK do .NET Core
* O Visual Studio para Windows
  * **Desenvolvimento do ASP.NET e web** carga de trabalho
