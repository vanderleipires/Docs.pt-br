...
- [Provedor de TempData baseado em cookie](xref:fundamentals/app-state#cookie-based-tempdata-provider )
- [Provedor de logs do Serviço de Aplicativo do Azure](xref:fundamentals/logging#appservice)
